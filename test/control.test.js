...
describe('control tests', () => {
            ...
            <fx-fore>
                <fx-model id="model1">
                    ...
                    <fx-bind ref="c" constraint="string-length(.) = 1">
                        <fx-alert
                            ><b
                                >string must be exactly 1 character long</b
                            ></fx-alert
                        >
                    </fx-bind>
                </fx-model>
    ...
    it('creates modelitem alerts', async () => {
        ...
        expect(ctrl.getModelItem().alerts[0]).to.equal(
...
*/
    ...
    it('creates non existing attributes', async () => {
        ...
        const item = fx.evaluateXPathToFirstNode(
            '//item',
            ...
            <fx-fore>
                ...
                <fieldset>
                    ...
                    <fx-control ref="radio">
                        ...
                        <fx-message event="value-changed"
                            >changed to {.}</fx-message
                        >
                    </fx-control>
                </fieldset>
