(() => {
  const td = Object.defineProperty; const id = Object.defineProperties; const nd = Object.getOwnPropertyDescriptors; const _l = Object.getOwnPropertySymbols; const sd = Object.prototype.hasOwnProperty; const rd = Object.prototype.propertyIsEnumerable; const jl = (i, e, t) => (e in i ? td(i, e, {
    ...
    iterRange(e, t = this.length) { return new Bn(this, e, t); }

    iterLines(e, t) { let n; if (e == null)n = this.iter(); else { t == null && (t = this.lines + 1); const s = this.line(e).from; n = this.iterRange(s, Math.max(s, t == this.lines + 1 ? this.length : t <= 1 ? 0 : this.line(t - 1).to)); } return new Nn(n); }
    ...
    decompose(e, t, n, s) { const r = e <= 0 && t >= this.length ? this : new Y(Xl(this.text, e, t), Math.min(t, this.length) - Math.max(0, e)); if (s & 1) { const o = n.pop(); const l = Rn(r.text, o.text.slice(), 0, r.length); if (l.length <= 32)n.push(new Y(l, o.length + r.length)); else { const a = l.length >> 1; n.push(new Y(l.slice(0, a)), new Y(l.slice(a))); } } else n.push(r); }

    replace(e, t, n) { if (!(n instanceof Y)) return super.replace(e, t, n); const s = Rn(this.text, Rn(n.text, Xl(this.text, 0, e)), t); const r = this.length + n.length - (t - e); return s.length <= 32 ? new Y(s, r) : Be.from(Y.split(s, []), r); }
...
`) { let s = ''; for (let r = 0, o = 0; r < this.children.length && o <= t; r++) { const l = this.children[r]; const a = o + l.length; o > e && r && (s += n), e < a && t > o && (s += l.sliceString(e - o, t - o, n)), o = a + 1; } return s; }
  ...
  }; z.empty = new Y([''], 0); function od(i) { let e = -1; for (const t of i)e += t.length + 1; return e; } function Rn(i, e, t = 0, n = 1e9) { for (let s = 0, r = 0, o = !0; r < i.length && s <= n; r++) { let l = i[r]; const a = s + l.length; a >= t && (a > n && (l = l.slice(0, n - s)), s < t && (l = l.slice(t - s)), o ? (e[e.length - 1] += l, o = !1) : e.push(l)), s = a + 1; } return e; } function Xl(i, e, t) { return Rn(i, [''], e, t); } var Ht = class {
...
`, this;
  ...
  }; typeof Symbol < 'u' && (z.prototype[Symbol.iterator] = function () { return this.iter(); }, Ht.prototype[Symbol.iterator] = Bn.prototype[Symbol.iterator] = Nn.prototype[Symbol.iterator] = function () { return this; }); var hr = class {
  ...
  }; function Wi(i) { return e => new $n(e, i); } const Ye = {
    highest: Wi(ni.highest), high: Wi(ni.high), default: Wi(ni.default), low: Wi(ni.low), lowest: Wi(ni.lowest),
  }; var $n = class {constructor(e, t) { this.inner = e, this.prec = t; }}; var li = class {
  ...
  }; var qi = class {constructor(e, t) { this.compartment = e, this.inner = t; }}; var ai = class {
  ...
  }; function fd(i, e, t) { const n = [[], [], [], [], []]; const s = new Map(); function r(o, l) { const a = s.get(o); if (a != null) { if (a <= l) return; const h = n[a].indexOf(o); h > -1 && n[a].splice(h, 1), o instanceof qi && t.delete(o.compartment); } if (s.set(o, l), Array.isArray(o)) for (const h of o)r(h, l); else if (o instanceof qi) { if (t.has(o.compartment)) throw new RangeError('Duplicate use of compartment in extensions'); const h = e.get(o.compartment) || o.inner; t.set(o.compartment, h), r(h, l); } else if (o instanceof $n)r(o.inner, o.prec); else if (o instanceof V)n[l].push(o), o.provides && r(o.provides, l); else if (o instanceof ri)n[l].push(o), o.facet.extensions && r(o.facet.extensions, l); else { const h = o.extension; if (!h) throw new Error(`Unrecognized extension value in extension set (${o}). This sometimes happens because multiple instances of @codemirror/state are loaded, breaking instanceof checks.`); r(h, l); } } return r(i, ni.default), n.reduce((o, l) => o.concat(l)); } function Hi(i, e) { if (e & 1) return 2; const t = e >> 1; const n = i.status[t]; if (n == 4) throw new Error('Cyclic dependency between fields and/or facets'); if (n & 2) return n; i.status[t] = 4; const s = i.computeSlot(i, i.config.dynamicSlots[t]); return i.status[t] = 2 | s; } function In(i, e) { return e & 1 ? i.config.staticValues[e >> 1] : i.values[e >> 1]; } const ha = v.define(); const ca = v.define({ combine: i => i.some(e => e), static: !0 }); const fa = v.define({ combine: i => (i.length ? i[0] : void 0), static: !0 }); const ua = v.define(); const da = v.define(); const pa = v.define(); const ma = v.define({ combine: i => (i.length ? i[0] : !1) }); const $e = class {
    ...
    field(e, t = !0) { const n = this.config.address[e.id]; if (n == null) { if (t) throw new RangeError('Field is not present in this state'); return; } return Hi(this, n), In(this, n); }
    ...
    facet(e) { const t = this.config.address[e.id]; return t == null ? e.default : (Hi(this, t), In(this, t)); }
...
`;
  ...
  }; je.prototype.startSide = je.prototype.endSide = 0; je.prototype.point = !1; je.prototype.mapMode = oe.TrackDel; var Ui = class {constructor(e, t, n) { this.from = e, this.to = t, this.value = n; }}; function yr(i, e) { return i.from - e.from || i.value.startSide - e.value.startSide; } var _i = class {
    ...
    update(e) {
      ...
      } = e; const o = e.filter; if (t.length == 0 && !o) return this; if (n && (t = t.slice().sort(yr)), this.isEmpty) return t.length ? I.of(t) : this; const l = new Fn(this, null, -1).goto(0); let a = 0; const h = []; const c = new Ee(); for (;l.value || a < t.length;) if (a < t.length && (l.from - t[a].from || l.startSide - t[a].value.startSide) >= 0) { const f = t[a++]; c.addInner(f.from, f.to, f.value) || h.push(f); } else l.rangeIndex == 1 && l.chunkIndex < this.chunk.length && (a == t.length || this.chunkEnd(l.chunkIndex) < t[a].from) && (!o || s > this.chunkEnd(l.chunkIndex) || r < this.chunkPos[l.chunkIndex]) && c.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex]) ? l.nextChunk() : ((!o || s > l.to || r < l.from || o(l.from, l.to, l.value)) && (c.addInner(l.from, l.to, l.value) || h.push(new Ui(l.from, l.to, l.value))), l.next()); return c.finishInner(this.nextLayer.isEmpty && !h.length ? I.empty : this.nextLayer.update({
    ...
    static of(e, t = !1) { const n = new Ee(); for (const s of e instanceof Ui ? [e] : t ? xd(e) : e)n.add(s.from, s.to, s.value); return n.finish(); }
    ...
    static from(e, t = null, n = -1) { const s = []; for (let r = 0; r < e.length; r++) for (let o = e[r]; !o.isEmpty; o = o.nextLayer)o.maxPoint >= n && s.push(new Fn(o, t, n, r)); return s.length == 1 ? s[0] : new Ut(s); }
...
`);
  ...
  }; let Vn = null; var Sr = class {
    constructor(e) { if (!e.head && e.adoptedStyleSheets && typeof CSSStyleSheet < 'u') { if (Vn) return e.adoptedStyleSheets = [Vn.sheet].concat(e.adoptedStyleSheets), e[Or] = Vn; this.sheet = new CSSStyleSheet(), e.adoptedStyleSheets = [this.sheet].concat(e.adoptedStyleSheets), Vn = this; } else { this.styleTag = (e.ownerDocument || e).createElement('style'); const t = e.head || e; t.insertBefore(this.styleTag, t.firstChild); } this.modules = [], e[Or] = this; }
...
`;
  ...
  }; const wa = typeof navigator < 'u' && /Chrome\/(\d+)/.exec(navigator.userAgent); const wd = typeof navigator < 'u' && /Apple Computer/.test(navigator.vendor); const kd = typeof navigator < 'u' && /Gecko\/\d+/.test(navigator.userAgent); const ka = typeof navigator < 'u' && /Mac/.test(navigator.platform); const vd = typeof navigator < 'u' && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent); const Od = wa && (ka || +wa[1] < 57) || kd && ka; for (se = 0; se < 10; se++)ft[48 + se] = ft[96 + se] = String(se); var se; for (se = 1; se <= 24; se++)ft[se + 111] = `F${se}`; var se; for (se = 65; se <= 90; se++)ft[se] = String.fromCharCode(se + 32), Hn[se] = String.fromCharCode(se); var se; for (Wn in ft)Hn.hasOwnProperty(Wn) || (Hn[Wn] = ft[Wn]); let Wn; function va(i) { const e = Od && (i.ctrlKey || i.altKey || i.metaKey) || (wd || vd) && i.shiftKey && i.key && i.key.length == 1; let t = !e && i.key || (i.shiftKey ? Hn : ft)[i.keyCode] || i.key || 'Unidentified'; return t == 'Esc' && (t = 'Escape'), t == 'Del' && (t = 'Delete'), t == 'Left' && (t = 'ArrowLeft'), t == 'Up' && (t = 'ArrowUp'), t == 'Right' && (t = 'ArrowRight'), t == 'Down' && (t = 'ArrowDown'), t; } function Qn(i) { let e; return i.nodeType == 11 ? e = i.getSelection ? i : i.ownerDocument : e = i, e.getSelection(); } function di(i, e) { return e ? i == e || i.contains(e.nodeType != 1 ? e.parentNode : e) : !1; } function Sd() { let i = document.activeElement; for (;i && i.shadowRoot;)i = i.shadowRoot.activeElement; return i; } function Br(i, e) { if (!e.anchorNode) return !1; try { return di(i, e.anchorNode); } catch { return !1; } } function sn(i) { return i.nodeType == 3 ? rn(i, 0, i.nodeValue.length).getClientRects() : i.nodeType == 1 ? i.getClientRects() : []; } function Xn(i, e, t, n) { return t ? Oa(i, e, t, n, -1) || Oa(i, e, t, n, 1) : !1; } function Nr(i) { for (let e = 0; ;e++) if (i = i.previousSibling, !i) return e; } function Oa(i, e, t, n, s) { for (;;) { if (i == t && e == n) return !0; if (e == (s < 0 ? 0 : Kn(i))) { if (i.nodeName == 'DIV') return !1; const r = i.parentNode; if (!r || r.nodeType != 1) return !1; e = Nr(i) + (s < 0 ? 0 : 1), i = r; } else if (i.nodeType == 1) { if (i = i.childNodes[e + (s < 0 ? -1 : 0)], i.nodeType == 1 && i.contentEditable == 'false') return !1; e = s < 0 ? Kn(i) : 0; } else return !1; } } function Kn(i) { return i.nodeType == 3 ? i.nodeValue.length : i.childNodes.length; } const ah = {
  ...
  }; let hi = null; function hh(i) { if (i.setActive) return i.setActive(); if (hi) return i.focus(hi); const e = []; for (let t = i; t && (e.push(t, t.scrollTop, t.scrollLeft), t != t.ownerDocument); t = t.parentNode);if (i.focus(hi == null ? { get preventScroll() { return hi = { preventScroll: !0 }, !0; } } : void 0), !hi) { hi = !1; for (let t = 0; t < e.length;) { const n = e[t++]; const s = e[t++]; const r = e[t++]; n.scrollTop != s && (n.scrollTop = s), n.scrollLeft != r && (n.scrollLeft = r); } } } let Sa; function rn(i, e, t = e) { const n = Sa || (Sa = document.createRange()); return n.setEnd(i, t), n.setStart(i, e), n; } function Ji(i, e, t) {
    const n = {
    ...
    localPosFromDOM(e, t) { let n; if (e == this.dom)n = this.dom.childNodes[t]; else { let s = Kn(e) == 0 ? 0 : t == 0 ? -1 : 1; for (;;) { const r = e.parentNode; if (r == this.dom) break; s == 0 && r.firstChild != r.lastChild && (e == r.firstChild ? s = -1 : s = 1), e = r; }s < 0 ? n = e : n = e.nextSibling; } if (n == this.dom.firstChild) return 0; for (;n && !K.get(n);)n = n.nextSibling; if (!n) return this.length; for (let s = 0, r = 0; ;s++) { const o = this.children[s]; if (o.dom == n) return r; r += o.length + o.breakAfter; } }
    ...
    childCursor(e = this.length) { return new Jn(this.children, e, this.children.length); }
  ...
  }; K.prototype.breakAfter = 0; function Ca(i) { const e = i.nextSibling; return i.parentNode.removeChild(i), e; } var Jn = class {
  ...
  }; function Vr(i, e, t) { const n = i.nodeValue.length; e > n && (e = n); let s = e; let r = e; let o = 0; e == 0 && t < 0 || e == n && t >= 0 ? E.chrome || E.gecko || (e ? (s--, o = 1) : (r++, o = -1)) : t < 0 ? s-- : r++; const l = rn(i, s, r).getClientRects(); if (!l.length) return ah; let a = l[(o ? o < 0 : t >= 0) ? 0 : l.length - 1]; return E.safari && !o && a.width == 0 && (a = Array.prototype.find.call(l, h => h.width) || a), o ? ds(a, o < 0) : a || null; } var tt = class extends K {
    ...
    coordsAt(e, t) { const n = this.dom.getClientRects(); let s = null; if (!n.length) return ah; for (let r = e > 0 ? n.length - 1 : 0; s = n[r], !(e > 0 ? r == 0 : r == n.length - 1 || s.top < s.bottom); r += e > 0 ? -1 : 1);return e == 0 && t > 0 || e == this.length && t <= 0 ? s : ds(s, e == 0); }

    get isEditable() { return !1; }

    destroy() { super.destroy(), this.dom && this.widget.destroy(this.dom); }
  }; const Yn = class extends tt {
    ...
    flushBuffer(e) { this.pendingBuffer && (this.curLine.append(qn(new Pt(-1), e), e.length), this.pendingBuffer = 0); }
    ...
    buildText(e, t, n) { for (;e > 0;) { if (this.textOff == this.text.length) { const { value: r, lineBreak: o, done: l } = this.cursor.next(this.skip); if (this.skip = 0, l) throw new Error('Ran out of text content when drawing inline views'); if (o) { this.posCovered() || this.getLine(), this.content.length ? this.content[this.content.length - 1].breakAfter = 1 : this.breakAtStart = 1, this.flushBuffer([]), this.curLine = null, e--; continue; } else this.text = r, this.textOff = 0; } const s = Math.min(this.text.length - this.textOff, e, 512); this.flushBuffer(t.slice(0, n)), this.getLine().append(qn(new nt(this.text.slice(this.textOff, this.textOff + s)), t), n), this.atCursorPos = !0, this.textOff += s, e -= s, n = 0; } }

    span(e, t, n, s) { this.buildText(t - e, n, s), this.pos = t, this.openStart < 0 && (this.openStart = s); }

    point(e, t, n, s, r, o) { if (this.disallowBlockEffectsFor[o] && n instanceof dt) { if (n.block) throw new RangeError('Block decorations may not be specified via plugins'); if (t > this.doc.lineAt(this.pos).to) throw new RangeError('Decorations that replace line breaks may not be specified via plugins'); } const l = t - e; if (n instanceof dt) if (n.block) { const { type: a } = n; a == _.WidgetAfter && !this.posCovered() && this.getLine(), this.addBlockWidget(new ut(n.widget || new es('div'), l, a)); } else { const a = tt.create(n.widget || new es('span'), l, n.startSide); const h = this.atCursorPos && !a.isEditable && r <= s.length && (e < t || n.startSide > 0); const c = !a.isEditable && (e < t || n.startSide <= 0); const f = this.getLine(); this.pendingBuffer == 2 && !h && (this.pendingBuffer = 0), this.flushBuffer(s), h && (f.append(qn(new Pt(1), s), r), r = s.length + Math.max(0, r - s.length)), f.append(qn(a, s), r), this.atCursorPos = c, this.pendingBuffer = c ? e < t ? 1 : 2 : 0; } else this.doc.lineAt(this.pos).from == this.pos && this.getLine().addLineDeco(n); l && (this.textOff + l <= this.text.length ? this.textOff += l : (this.skip += l - (this.text.length - this.textOff), this.text = '', this.textOff = 0), this.pos = t), this.openStart < 0 && (this.openStart = r); }

    static build(e, t, n, s, r) { const o = new on(e, t, n, r); return o.openEnd = I.spans(s, t, n, o), o.openStart < 0 && (o.openStart = o.openEnd), o.finish(o.openEnd), o; }
  }; function qn(i, e) { for (const t of e)i = new Fe(t, [i], i.length); return i; } var es = class extends Ae {
  ...
  }; const Ma = M.define({ map: (i, e) => i.map(e) }); function ge(i, e, t) { const n = i.facet(Oh); n.length ? n[0](e) : window.onerror ? window.onerror(String(e), t, void 0, void 0, e) : t ? console.error(`${t}:`, e) : console.error(e); } const cn = v.define({ combine: i => (i.length ? i[0] : !0) }); let Ld = 0; const Gi = v.define(); var q = class {
    constructor(e, t, n, s) { this.id = e, this.create = t, this.domEventHandlers = n, this.extension = s(this); }

    static define(e, t) { const { eventHandlers: n, provide: s, decorations: r } = t || {}; return new q(Ld++, e, n, (o) => { const l = [Gi.of(o)]; return r && l.push(ln.of((a) => { const h = a.plugin(o); return h ? r(h) : A.none; })), s && l.push(s(o)), l; }); }
  ...
  }; const Ah = v.define(); const Th = v.define(); var ln = v.define(); const Ph = v.define(); const Mh = v.define(); const Zi = v.define(); var Ge = class {
  ...
  }; function Ea(i) { return i.nodeType == 1 && /^(DIV|P|LI|UL|OL|BLOCKQUOTE|DD|DT|H\d|SECTION|PRE)$/.test(i.nodeName); } const ns = class {constructor(e, t) { this.node = e, this.offset = t, this.pos = -1; }}; const ss = class extends K {
    ...
    updateInner(e, t) { this.view.viewState.mustMeasureContent = !0, this.updateChildren(e, t); const { observer: n } = this.view; n.ignore(() => { this.dom.style.height = `${this.view.viewState.contentHeight}px`, this.dom.style.minWidth = this.minWidth ? `${this.minWidth}px` : ''; const r = E.chrome || E.ios ? { node: n.selectionRange.focusNode, written: !1 } : void 0; this.sync(r), this.dirty = 0, r && (r.written || n.selectionRange.focusNode != r.node) && (this.forceSelection = !0), this.dom.style.height = ''; }); const s = []; if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length) for (const r of this.children)r instanceof ut && r.widget instanceof rs && s.push(r.dom); n.updateGaps(s); }
    ...
    updateChildren(e, t) {
      const n = this.childCursor(t); for (let s = e.length - 1; ;s--) {
        ...
        } = on.build(this.view.state.doc, a, h, this.decorations, this.dynamicDecorationMap); const { i: p, off: g } = n.findPos(l, 1); const { i: b, off: y } = n.findPos(o, -1); fh(this, b, y, p, g, c, f, u, d);
      }
    }

    updateSelection(e = !1, t = !1) { if (e && this.view.observer.readSelectionRange(), !(t || this.mayControlSelection()) || E.ios && this.view.inputState.rapidCompositionStart) return; let n = this.forceSelection; this.forceSelection = !1; const s = this.view.state.selection.main; let r = this.domAtPos(s.anchor); let o = s.empty ? r : this.domAtPos(s.head); if (E.gecko && s.empty && Vd(r)) { const a = document.createTextNode(''); this.view.observer.ignore(() => r.node.insertBefore(a, r.node.childNodes[r.offset] || null)), r = o = new ce(a, 0), n = !0; } const l = this.view.observer.selectionRange; (n || !l.focusNode || !Xn(r.node, r.offset, l.anchorNode, l.anchorOffset) || !Xn(o.node, o.offset, l.focusNode, l.focusOffset)) && (this.view.observer.ignore(() => { E.android && E.chrome && this.dom.contains(l.focusNode) && Ud(l.focusNode, this.dom) && (this.dom.blur(), this.dom.focus({ preventScroll: !0 })); const a = Qn(this.root); if (s.empty) { if (E.gecko) { const h = Hd(r.node, r.offset); if (h && h != 3) { const c = Bh(r.node, r.offset, h == 1 ? 1 : -1); c && (r = new ce(c, h == 1 ? 0 : c.nodeValue.length)); } }a.collapse(r.node, r.offset), s.bidiLevel != null && l.cursorBidiLevel != null && (l.cursorBidiLevel = s.bidiLevel); } else if (a.extend)a.collapse(r.node, r.offset), a.extend(o.node, o.offset); else { const h = document.createRange(); s.anchor > s.head && ([r, o] = [o, r]), h.setEnd(o.node, o.offset), h.setStart(r.node, r.offset), a.removeAllRanges(), a.addRange(h); } }), this.view.observer.setSelectionRange(r, o)), this.impreciseAnchor = r.precise ? null : new ce(l.anchorNode, l.anchorOffset), this.impreciseHead = o.precise ? null : new ce(l.focusNode, l.focusOffset); }

    enforceCursorAssoc() { if (this.compositionDeco.size) return; const e = this.view.state.selection.main; const t = Qn(this.root); if (!e.empty || !e.assoc || !t.modify) return; const n = pe.find(this, e.head); if (!n) return; const s = n.posAtStart; if (e.head == s || e.head == s + n.length) return; const r = this.coordsAt(e.head, -1); const o = this.coordsAt(e.head, 1); if (!r || !o || r.bottom > o.top) return; const l = this.domAtPos(e.head + e.assoc); t.collapse(l.node, l.offset), t.modify('move', e.assoc < 0 ? 'forward' : 'backward', 'lineboundary'); }

    mayControlSelection() { return this.view.state.facet(cn) ? this.root.activeElement == this.dom : Br(this.dom, this.view.observer.selectionRange); }
    ...
    measureVisibleLineHeights(e) { const t = []; const { from: n, to: s } = e; const r = this.view.contentDOM.clientWidth; const o = r > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1; let l = -1; const a = this.view.textDirection == G.LTR; for (let h = 0, c = 0; c < this.children.length; c++) { const f = this.children[c]; const u = h + f.length; if (u > s) break; if (h >= n) { const d = f.dom.getBoundingClientRect(); if (t.push(d.height), o) { const p = f.dom.lastChild; const g = p ? sn(p) : []; if (g.length) { const b = g[g.length - 1]; const y = a ? b.right - d.left : d.right - b.left; y > l && (l = y, this.minWidth = r, this.minWidthFrom = h, this.minWidthTo = u); } } }h = u + f.breakAfter; } return t; }
    ...
    childCursor(e = this.length) { let t = this.children.length; return t && (e -= this.children[--t].length), new Jn(this.children, e, t); }
      ...
      const e = []; const t = this.view.viewState; for (let n = 0, s = 0; ;s++) {
        const r = s == t.viewports.length ? null : t.viewports[s]; const o = r ? r.from - 1 : this.length; if (o > n) {
          const l = t.lineBlockAt(o).bottom - t.lineBlockAt(n).top; e.push(A.replace({
            widget: new rs(l), block: !0, inclusive: !0, isBlockGap: !0,
          }).range(n, o));
        } if (!r) break; n = r.to + 1;
      } return A.set(e);
    }
  ...
  }; function Vd(i) { return i.node.nodeType == 1 && i.node.firstChild && (i.offset == 0 || i.node.childNodes[i.offset - 1].contentEditable == 'false') && (i.offset == i.node.childNodes.length || i.node.childNodes[i.offset].contentEditable == 'false'); } var rs = class extends Ae {
    ...
    } = t; let l = e.mapPos(n, 1); let a = Math.max(l, e.mapPos(s, -1)); const { state: h } = i; const c = r.nodeType == 3 ? r.nodeValue : new is([], h).readRange(r.firstChild, null).text; if (a - l < c.length) if (h.doc.sliceString(l, Math.min(h.doc.length, l + c.length), At) == c)a = l + c.length; else if (h.doc.sliceString(Math.max(0, a - c.length), a, At) == c)l = a - c.length; else return A.none; else if (h.doc.sliceString(l, a, At) != c) return A.none; let f = K.get(r); return f instanceof Yn ? f = f.widget.topView : f && (f.parent = null), A.set(A.replace({ widget: new Zr(r, o, f) }).range(l, a));
    ...
    get customView() { return Yn; }
  }; function Bh(i, e, t) { for (;;) { if (i.nodeType == 3) return i; if (i.nodeType == 1 && e > 0 && t <= 0)i = i.childNodes[e - 1], e = Kn(i); else if (i.nodeType == 1 && e < i.childNodes.length && t >= 0)i = i.childNodes[e], e = 0; else return null; } } function Hd(i, e) { return i.nodeType != 1 ? 0 : (e && i.childNodes[e - 1].contentEditable == 'false' ? 1 : 0) | (e < i.childNodes.length && i.childNodes[e].contentEditable == 'false' ? 2 : 0); } const Qr = class {
  ...
  } function Xr(i, e, t) { let n; let s; let r; let o; let l; let a; let h; let c; for (let d = i.firstChild; d; d = d.nextSibling) { const p = sn(d); for (let g = 0; g < p.length; g++) { let b = p[g]; s && Ar(s, b) && (b = Da(La(b, s.bottom), s.top)); const y = jd(e, b); const S = Gd(t, b); if (y == 0 && S == 0) return d.nodeType == 3 ? Ra(d, e, t) : Xr(d, e, t); (!n || o > S || o == S && r > y) && (n = d, s = b, r = y, o = S), y == 0 ? t > b.bottom && (!h || h.bottom < b.bottom) ? (l = d, h = b) : t < b.top && (!c || c.top > b.top) && (a = d, c = b) : h && Ar(h, b) ? h = La(h, b.bottom) : c && Ar(c, b) && (c = Da(c, b.top)); } } if (h && h.bottom >= t ? (n = l, s = h) : c && c.top <= t && (n = a, s = c), !n) return { node: i, offset: 0 }; const f = Math.max(s.left, Math.min(s.right, e)); if (n.nodeType == 3) return Ra(n, f, t); if (!r && n.contentEditable == 'true') return Xr(n, f, t); const u = Array.prototype.indexOf.call(i.childNodes, n) + (e >= (s.left + s.right) / 2 ? 1 : 0); return { node: i, offset: u }; } function Ra(i, e, t) { const n = i.nodeValue.length; let s = -1; let r = 1e9; let o = 0; for (let l = 0; l < n; l++) { const a = rn(i, l, l + 1).getClientRects(); for (let h = 0; h < a.length; h++) { const c = a[h]; if (c.top == c.bottom) continue; o || (o = e - c.left); const f = (c.top > t ? c.top - t : t - c.bottom) - 1; if (c.left - 1 <= e && c.right + 1 >= e && f < r) { const u = e >= (c.left + c.right) / 2; let d = u; if ((E.chrome || E.gecko) && rn(i, l).getBoundingClientRect().left == c.right && (d = !u), f <= 0) return { node: i, offset: l + (d ? 1 : 0) }; s = l + (d ? 1 : 0), r = f; } } } return { node: i, offset: s > -1 ? s : o > 0 ? i.nodeValue.length : 0 }; } function Nh(i, { x: e, y: t }, n, s = -1) { let r; const o = i.contentDOM.getBoundingClientRect(); const l = o.top + i.viewState.paddingTop; let a; const { docHeight: h } = i.viewState; let c = t - l; if (c < 0) return 0; if (c > h) return i.state.doc.length; for (let y = i.defaultLineHeight / 2, S = !1; a = i.elementAtHeight(c), a.type != _.Text;) for (;c = s > 0 ? a.bottom + y : a.top - y, !(c >= 0 && c <= h);) { if (S) return n ? null : 0; S = !0, s = -s; }t = l + c; const f = a.from; if (f < i.viewport.from) return i.viewport.from == 0 ? 0 : n ? null : Ba(i, o, a, e, t); if (f > i.viewport.to) return i.viewport.to == i.state.doc.length ? i.state.doc.length : n ? null : Ba(i, o, a, e, t); const u = i.dom.ownerDocument; const d = i.root.elementFromPoint ? i.root : u; let p = d.elementFromPoint(e, t); p && !i.contentDOM.contains(p) && (p = null), p || (e = Math.max(o.left + 1, Math.min(o.right - 1, e)), p = d.elementFromPoint(e, t), p && !i.contentDOM.contains(p) && (p = null)); let g; let b = -1; if (p && ((r = i.docView.nearest(p)) === null || r === void 0 ? void 0 : r.isEditable) != !1) { if (u.caretPositionFromPoint) { const y = u.caretPositionFromPoint(e, t); y && ({ offsetNode: g, offset: b } = y); } else if (u.caretRangeFromPoint) { const y = u.caretRangeFromPoint(e, t); y && ({ startContainer: g, startOffset: b } = y, E.safari && Zd(g, b, e) && (g = void 0)); } } if (!g || !i.docView.dom.contains(g)) { const y = pe.find(i.docView, f); if (!y) return c > a.top + a.height / 2 ? a.to : a.from; ({ node: g, offset: b } = Xr(y.dom, e, t)); } return i.docView.posFromDOM(g, b); } function Ba(i, e, t, n, s) { let r = Math.round((n - e.left) * i.defaultCharacterWidth); i.lineWrapping && t.height > i.defaultLineHeight * 1.5 && (r += Math.floor((s - t.top) / i.defaultLineHeight) * i.viewState.heightOracle.lineLength); const o = i.state.sliceDoc(t.from, t.to); return t.from + zn(o, r, i.state.tabSize); } function Zd(i, e, t) { let n; if (i.nodeType != 3 || e != (n = i.nodeValue.length)) return !1; for (let s = i.nextSibling; s; s = s.nextSibling) if (s.nodeType != 1 || s.nodeName != 'BR') return !1; return rn(i, n - 1, n).getBoundingClientRect().left > t; } function Qd(i, e, t, n) { const s = i.state.doc.lineAt(e.head); const r = !n || !i.lineWrapping ? null : i.coordsAtPos(e.assoc < 0 && e.head > s.from ? e.head - 1 : e.head); if (r) { const a = i.dom.getBoundingClientRect(); const h = i.textDirectionAt(s.from); const c = i.posAtCoords({ x: t == (h == G.LTR) ? a.right - 1 : a.left + 1, y: (r.top + r.bottom) / 2 }); if (c != null) return m.cursor(c, t ? -1 : 1); } const o = pe.find(i.docView, e.head); const l = o ? t ? o.posAtEnd : o.posAtStart : t ? s.to : s.from; return m.cursor(l, t ? -1 : 1); } function Na(i, e, t, n) {
...
`, s = i.state.doc.line(s.number + (t ? 1 : -1)), r = i.bidiSpans(s), h = m.cursor(t ? s.from : s.to);
  ...
  }; var j = (function (i) { return i[i.ByPos = 0] = 'ByPos', i[i.ByHeight = 1] = 'ByHeight', i[i.ByPosNoHeight = 2] = 'ByPosNoHeight', i; }(j || (j = {}))); const jn = 0.001; var be = class {
    ...
    setHeight(e, t) { this.height != t && (Math.abs(this.height - t) > jn && (e.heightChanged = !0), this.height = t); }
  ...
  }; be.prototype.size = 1; const os = class extends be {
    ...
    updateHeight(e, t = 0, n = !1, s) { const r = t + this.length; if (s && s.from <= t + this.length && s.more) { const o = []; let l = Math.max(t, s.from); let a = -1; const h = e.heightChanged; for (s.from > t && o.push(new he(s.from - t - 1).updateHeight(e, t)); l <= r && s.more;) { const f = e.doc.lineAt(l).length; o.length && o.push(null); const u = s.heights[s.index++]; a == -1 ? a = u : Math.abs(u - a) >= jn && (a = -2); const d = new Oe(f, u); d.outdated = !1, o.push(d), l += f + 1; }l <= r && o.push(null, new he(r - l).updateHeight(e, l)); const c = be.of(o); return e.heightChanged = h || a < 0 || Math.abs(c.height - this.height) >= jn || Math.abs(a - this.lines(e.doc, t).lineHeight) >= jn, c; } else (n || this.outdated) && (this.setHeight(e, e.heightForGap(t, t + this.length)), this.outdated = !1); return this; }
  ...
  }; function _a(i, e) { let t; let n; i[e] == null && (t = i[e - 1]) instanceof he && (n = i[e + 1]) instanceof he && i.splice(e - 1, 3, new he(t.length + 1 + n.length)); } const lp = 5; var an = class {
    ...
    point(e, t, n) { if (e < t || n.heightRelevant) { let s = n.widget ? n.widget.estimatedHeight : 0; s < 0 && (s = this.oracle.lineHeight); const r = t - e; n.block ? this.addBlock(new os(r, s, n.type)) : (r || s >= lp) && this.addLineDeco(s, r); } else t > e && this.span(e, t); this.lineEnd > -1 && this.lineEnd < this.pos && (this.lineEnd = this.oracle.doc.lineAt(this.pos).to); }
    ...
    static build(e, t, n, s) { const r = new an(n, e); return I.spans(t, n, s, r, 0), r.finish(n); }
    ...
    ensureLineGaps(e) { const t = []; if (this.defaultTextDirection != G.LTR) return t; for (const n of this.viewportLines) { if (n.length < 4e3) continue; const s = fp(n.from, n.to, this.stateDeco); if (s.total < 4e3) continue; let r; let o; if (this.heightOracle.lineWrapping) { const h = 2e3 / this.heightOracle.lineLength * this.heightOracle.lineHeight; r = Un(s, (this.visibleTop - n.top - h) / n.height), o = Un(s, (this.visibleBottom - n.top + h) / n.height); } else { const h = s.total * this.heightOracle.charWidth; const c = 2e3 * this.heightOracle.charWidth; r = Un(s, (this.pixelViewport.left - c) / h), o = Un(s, (this.pixelViewport.right + c) / h); } const l = []; r > n.from && l.push({ from: n.from, to: r }), o < n.to && l.push({ from: o, to: n.to }); const a = this.state.selection.main; a.from >= n.from && a.from <= n.to && Ga(l, a.from - 10, a.from + 10), !a.empty && a.to >= n.from && a.to <= n.to && Ga(l, a.to - 10, a.to + 10); for (const { from: h, to: c } of l)c - h > 1e3 && t.push(up(e, f => f.from >= n.from && f.to <= n.to && Math.abs(f.from - h) < 1e3 && Math.abs(f.to - c) < 1e3) || new en(h, c, this.gapSize(n, h, c, s))); } return t; }
    ...
    onSelectionChange(e) { if (!this.readSelectionRange() || this.delayedAndroidKey) return; const { view: t } = this; const n = this.selectionRange; if (t.state.facet(cn) ? t.root.activeElement != this.dom : !Br(t.dom, n)) return; const s = n.anchorNode && t.docView.nearest(n.anchorNode); s && s.ignoreEvent(e) || ((E.ie && E.ie_version <= 11 || E.android && E.chrome) && !t.state.selection.main.empty && n.focusNode && Xn(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset) ? this.flushSoon() : this.flush(!1)); }

    readSelectionRange() { const { root: e } = this.view; const t = Qn(e); const n = E.safari && e.nodeType == 11 && Sd() == this.view.contentDOM && mp(this.view) || t; return this.selectionRange.eq(n) ? !1 : (this.selectionRange.setRange(n), this.selectionChanged = !0); }
    ...
    update(e) { if (this.updateState != 0) throw new Error('Calls to EditorView.update are not allowed while an update is in progress'); let t = !1; let n; let s = this.state; for (const o of e) { if (o.startState != s) throw new RangeError("Trying to update state with a transaction that doesn't start from the previous state."); s = o.state; } if (this.destroyed) { this.viewState.state = s; return; } if (s.facet($.phrases) != this.state.facet($.phrases)) return this.setState(s); n = new ts(this, s, e); let r = this.viewState.scrollTarget; try { this.updateState = 2; for (const o of e) { if (r && (r = r.map(o.changes)), o.scrollIntoView) { const { main: l } = o.state.selection; r = new mi(l.empty ? l : m.cursor(l.head, l.head > l.anchor ? -1 : 1)); } for (const l of o.effects)l.is(Ma) && (r = l.value); } this.viewState.update(n, r), this.bidiCache = gi.update(this.bidiCache, n.changes), n.empty || (this.updatePlugins(n), this.inputState.update(n)), t = this.docView.update(n), this.state.facet(Zi) != this.styleModules && this.mountStyles(), this.updateAttrs(), this.showAnnouncements(e), this.docView.updateSelection(t, e.some(o => o.isUserEvent('select.pointer'))); } finally { this.updateState = 0; } if (n.startState.facet(_n) != n.state.facet(_n) && (this.viewState.mustMeasureContent = !0), (t || r || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), !n.empty) for (const o of this.state.facet(_r))o(n); }

    setState(e) { if (this.updateState != 0) throw new Error('Calls to EditorView.setState are not allowed while an update is in progress'); if (this.destroyed) { this.viewState.state = e; return; } this.updateState = 2; const t = this.hasFocus; try { for (const n of this.plugins)n.destroy(this); this.viewState = new ls(e), this.plugins = e.facet(Gi).map(n => new Yi(n)), this.pluginMap.clear(); for (const n of this.plugins)n.update(this); this.docView = new ss(this), this.inputState.ensureHandlers(this, this.plugins), this.mountStyles(), this.updateAttrs(), this.bidiCache = []; } finally { this.updateState = 0; }t && this.focus(), this.requestMeasure(); }
    ...
    mountStyles() { this.styleModules = this.state.facet(Zi), Ie.mount(this.root, this.styleModules.concat(dp).reverse()); }
    ...
    coordsAtPos(e, t = 1) { this.readMeasured(); const n = this.docView.coordsAt(e, t); if (!n || n.left == n.right) return n; const s = this.state.doc.lineAt(e); const r = this.bidiSpans(s); const o = r[Tt.find(r, e - s.from, -1, t)]; return ds(n, o.dir == G.LTR == t > 0); }
    ...
    static theme(e, t) { const n = Ie.newName(); const s = [_n.of(n), Zi.of(ao(`.${n}`, e))]; return t && t.dark && s.push(oo.of(!0)), s; }

    static baseTheme(e) { return Ye.lowest(Zi.of(ao(`.${lo}`, e, _h))); }
  }; O.styleModule = Zi; O.inputHandler = Sh; O.perLineTextDirection = Ch; O.exceptionSink = Oh; O.updateListener = _r; O.editable = cn; O.mouseSelectionStyle = vh; O.dragMovesSelection = kh; O.clickAddsSelectionRange = wh; O.decorations = ln; O.atomicRanges = Ph; O.scrollMargins = Mh; O.darkTheme = oo; O.contentAttributes = Th; O.editorAttributes = Ah; O.lineWrapping = O.contentAttributes.of({ class: 'cm-lineWrapping' }); O.announce = M.define(); var wp = 4096; var Xa = {}; var gi = class {
    ...
    setBlinkRate() { this.cursorLayer.style.animationDuration = `${this.view.state.facet(Xi).cursorBlinkRate}ms`; }

    update(i) { const e = i.startState.facet(Xi) != i.state.facet(Xi); (e || i.selectionSet || i.geometryChanged || i.viewportChanged) && this.view.requestMeasure(this.measureReq), i.transactions.some(t => t.scrollIntoView) && (this.cursorLayer.style.animationName = this.cursorLayer.style.animationName == 'cm-blink' ? 'cm-blink2' : 'cm-blink'), e && this.setBlinkRate(); }

    readPos() { const { state: i } = this.view; const e = i.facet(Xi); const t = i.selection.ranges.map(s => (s.empty ? [] : Pp(this.view, s))).reduce((s, r) => s.concat(r)); const n = []; for (const s of i.selection.ranges) { const r = s == i.selection.main; if (s.empty ? !r || Qh : e.drawRangeCursor) { const o = Mp(this.view, s, r); o && n.push(o); } } return { rangePieces: t, cursors: n }; }
    ...
    setDropPos(i) { this.view.state.field(Ki) != i && this.view.dispatch({ effects: Yh.of(i) }); }
  }, {
    eventHandlers: {
...
-\x7F-\x9F\xAD\u061C\u200B\u200E\u200F\u2028\u2029\u202D\u202E\uFEFF\uFFF9-\uFFFC]`, fo); const Rp = {
  ...
  }; let Er = null; function Bp() { let i; if (Er == null && typeof document < 'u' && document.body) { const e = document.body.style; Er = ((i = e.tabSize) !== null && i !== void 0 ? i : e.MozTabSize) != null; } return Er || !1; } const Gn = v.define({ combine(i) { const e = me(i, { render: null, specialChars: Lp, addSpecialChars: null }); return (e.replaceTabs = !Bp()) && (e.specialChars = new RegExp(`	|${e.specialChars.source}`, fo)), e.addSpecialChars && (e.specialChars = new RegExp(`${e.specialChars.source}|${e.addSpecialChars.source}`, fo)), e; } }); function tc(i = {}) { return [Gn.of(i), Np()]; } let ih = null; function Np() {
    return ih || (ih = q.fromClass(class {
      constructor(i) { this.view = i, this.decorations = A.none, this.decorationCache = Object.create(null), this.decorator = this.makeDecorator(i.state.facet(Gn)), this.decorations = this.decorator.createDeco(i); }
      ...
      update(i) { const e = i.state.facet(Gn); i.startState.facet(Gn) != e ? (this.decorator = this.makeDecorator(e), this.decorations = this.decorator.createDeco(i.view)) : this.decorations = this.decorator.updateDeco(i, this.decorations); }
  ...
  } const Dr = '-10000px'; const hs = class {
  ...
  }); var Gp = { x: 0, y: 0 }; var bi = v.define({ enables: [rc, jp] }); const cs = v.define(); var hn = class {
    constructor(e) { this.view = e, this.mounted = !1, this.dom = document.createElement('div'), this.dom.classList.add('cm-tooltip-hover'), this.manager = new hs(e, cs, t => this.createHostedView(t)); }
  ...
  }; const Zp = bi.compute([cs], (i) => {
    const e = i.facet(cs).filter(t => t); return e.length === 0 ? null : {
    ...
    destroy(e) {}
  }; Te.prototype.elementClass = ''; Te.prototype.toDOM = void 0; Te.prototype.mapMode = oe.TrackBefore; Te.prototype.startSide = Te.prototype.endSide = -1; Te.prototype.point = !0; const Zn = v.define(); const Jp = {
  ...
  }; const tn = v.define(); function ms(i) { return [hc(), tn.of({ ...Jp, ...i })]; } const bo = v.define({ combine: i => i.some(e => e) }); function hc(i) { const e = [Yp]; return i && i.fixed === !1 && e.push(bo.of(!0)), e; } var Yp = q.fromClass(class {
    constructor(i) { this.view = i, this.prevViewport = i.viewport, this.dom = document.createElement('div'), this.dom.className = 'cm-gutters', this.dom.setAttribute('aria-hidden', 'true'), this.dom.style.minHeight = `${this.view.contentHeight}px`, this.gutters = i.state.facet(tn).map(e => new fs(i, e)); for (const e of this.gutters) this.dom.appendChild(e.dom); this.fixed = !i.state.facet(bo), this.fixed && (this.dom.style.position = 'sticky'), this.syncGutters(!1), i.scrollDOM.insertBefore(this.dom, i.contentDOM); }
    ...
    syncGutters(i) { const e = this.dom.nextSibling; i && this.dom.remove(); const t = I.iter(this.view.state.facet(Zn), this.view.viewport.from); let n = []; const s = this.gutters.map(r => new yo(r, this.view.viewport, -this.view.documentPadding.top)); for (const r of this.view.viewportLineBlocks) { let o; if (Array.isArray(r.type)) { for (const l of r.type) if (l.type == _.Text) { o = l; break; } } else o = r.type == _.Text ? r : void 0; if (o) { n.length && (n = []), cc(t, n, r.from); for (const l of s)l.line(this.view, o, n); } } for (const r of s)r.finish(); i && this.view.scrollDOM.insertBefore(this.dom, e); }

    updateGutters(i) { const e = i.startState.facet(tn); const t = i.state.facet(tn); let n = i.docChanged || i.heightChanged || i.viewportChanged || !I.eq(i.startState.facet(Zn), i.state.facet(Zn), i.view.viewport.from, i.view.viewport.to); if (e == t) for (const s of this.gutters)s.update(i) && (n = !0); else { n = !0; const s = []; for (const r of t) { const o = e.indexOf(r); o < 0 ? s.push(new fs(this.view, r)) : (this.gutters[o].update(i), s.push(this.gutters[o])); } for (const r of this.gutters)r.dom.remove(), s.indexOf(r) < 0 && r.destroy(); for (const r of s) this.dom.appendChild(r.dom); this.gutters = s; } return n; }
    ...
    line(e, t, n) { this.localMarkers.length && (this.localMarkers = []), cc(this.cursor, this.localMarkers, t.from); const s = n.length ? this.localMarkers.concat(n) : this.localMarkers; const r = this.gutter.config.lineMarker(e, t, s); r && s.unshift(r); const o = this.gutter; if (s.length == 0 && !o.config.renderEmptyElements) return; const l = t.top - this.height; if (this.i == o.elements.length) { const a = new us(e, t.height, l, s); o.elements.push(a), o.dom.appendChild(a.dom); } else o.elements[this.i].update(e, t.height, l, s); this.height = t.bottom, this.i++; }
  ...
  }; function em(i, e) { if (i.length != e.length) return !1; for (let t = 0; t < i.length; t++) if (!i[t].compare(e[t])) return !1; return !0; } const tm = v.define(); const ui = v.define({ combine(i) { return me(i, { formatNumber: String, domEventHandlers: {} }, { domEventHandlers(e, t) { const n = { ...e }; for (const s in t) { const r = n[s]; const o = t[s]; n[s] = r ? (l, a, h) => r(l, a, h) || o(l, a, h) : o; } return n; } }); } }); const nn = class extends Te {
    constructor(e) { super(), this.number = e; }

    eq(e) { return this.number == e.number; }

    toDOM() { return document.createTextNode(this.number); }
  }; function Rr(i, e) { return i.state.facet(ui).formatNumber(e, i.state); } const im = tn.compute([ui], i => ({
    class: 'cm-lineNumbers', renderEmptyElements: !1, markers(e) { return e.state.facet(tm); }, lineMarker(e, t, n) { return n.some(s => s.toDOM) ? null : new nn(Rr(e, e.state.doc.lineAt(t.from).number)); }, lineMarkerChange: e => e.startState.facet(ui) != e.state.facet(ui), initialSpacer(e) { return new nn(Rr(e, lh(e.state.doc.lines))); }, updateSpacer(e, t) { const n = Rr(t.view, lh(t.view.state.doc.lines)); return n == e.number ? e : new nn(n); }, domEventHandlers: i.facet(ui).domEventHandlers,
    ...
    sm = Zn.compute(['selection'], (i) => { const e = []; let t = -1; for (const n of i.selection.ranges) if (n.empty) { const s = i.doc.lineAt(n.head).from; s > t && (t = s, e.push(nm.range(s))); } return I.of(e); }); function uc() { return sm; } let rm = 0; const fn = class {constructor(e, t) { this.from = e, this.to = t; }}; const R = class {
  ...
  }; const gs = new WeakMap(); const dc = new WeakMap(); let fe; (function (i) { i[i.ExcludeBuffers = 1] = 'ExcludeBuffers', i[i.IncludeAnonymous = 2] = 'IncludeAnonymous', i[i.IgnoreMounts = 4] = 'IgnoreMounts', i[i.IgnoreOverlays = 8] = 'IgnoreOverlays'; }(fe || (fe = {}))); var J = class {
    ...
    cursorAt(e, t = 0, n = 0) { const s = gs.get(this) || this.topNode; const r = new xi(s); return r.moveTo(e, t), gs.set(this, r._tree), r; }

    get topNode() { return new Ze(this, 0, 0, null); }

    resolve(e, t = 0) { const n = yi(gs.get(this) || this.topNode, e, t, !1); return gs.set(this, n), n; }
    ...
    getChild(e, t = null, n = null) { const s = ys(this, e, t, n); return s.length ? s[0] : null; }

    getChildren(e, t = null, n = null) { return ys(this, e, t, n); }

    toString() { return this._tree.toString(); }

    get node() { return this; }

    matchContext(e) { return xs(this, e); }
  }; function ys(i, e, t, n) { const s = i.cursor(); const r = []; if (!s.firstChild()) return r; if (t != null) { for (;!s.type.is(t);) if (!s.nextSibling()) return r; } for (;;) { if (n != null && s.type.is(n)) return r; if (s.type.is(e) && r.push(s.node), !s.nextSibling()) return n == null ? r : []; } } function xs(i, e, t = e.length - 1) { for (let n = i.parent; t >= 0; n = n.parent) { if (!n) return !1; if (!n.type.isAnonymous) { if (e[t] && e[t] != n.name) return !1; t--; } } return !0; } var vo = class {constructor(e, t, n, s) { this.parent = e, this.buffer = t, this.index = n, this.start = s; }}; var st = class {
    ...
    matchContext(e) { if (!this.buffer) return xs(this.node, e); const { buffer: t } = this.buffer; const { types: n } = t.set; for (let s = e.length - 1, r = this.stack.length - 1; s >= 0; r--) { if (r < 0) return xs(this.node, e, s); const o = n[t.buffer[this.stack[r]]]; if (!o.isAnonymous) { if (e[s] && e[s] != o.name) return !1; s--; } } return !0; }
    ...
    } = i; const l = Array.isArray(t) ? new un(t, t.length) : t; const a = n.types; let h = 0; let c = 0; function f(k, C, T, D, Z) {
      const {
  ...
  } const pc = new WeakMap(); function bs(i, e) { if (!i.isAnonymous || e instanceof mt || e.type != i) return 1; let t = pc.get(e); if (t == null) { t = 1; for (const n of e.children) { if (n.type != i || !(n instanceof J)) { t = 1; break; }t += bs(i, n); }pc.set(e, t); } return t; } function Co(i, e, t, n, s, r, o, l, a) { let h = 0; for (let p = n; p < s; p++)h += bs(i, e[p]); const c = Math.ceil(h * 1.5 / 8); const f = []; const u = []; function d(p, g, b, y, S) { for (let P = b; P < y;) { const k = P; const C = g[P]; let T = bs(i, p[P]); for (P++; P < y; P++) { const D = bs(i, p[P]); if (T + D >= c) break; T += D; } if (P == k + 1) { if (T > c) { const D = p[k]; d(D.children, D.positions, 0, D.children.length, g[k] + S); continue; }f.push(p[k]); } else { const D = g[P - 1] + p[P - 1].length - C; f.push(Co(i, p, g, k, P, C, D, null, a)); }u.push(C + S - r); } } return d(e, t, n, s, 0), (l || a)(f, u, o); } var rt = class {
    ...
    startParse(e, t, n) { return typeof e === 'string' && (e = new Oo(e)), n = n ? n.length ? n.map(s => new fn(s.from, s.to)) : [new fn(0, 0)] : [new fn(0, e.length)], this.createParse(e, t || [], n); }
  ...
  }; const w = ze.define; const ws = w(); const Mt = w(); const bc = w(Mt); const yc = w(Mt); const Et = w(); const ks = w(Et); const Ao = w(Et); const at = w(); const Zt = w(at); const ot = w(); const lt = w(); const Mo = w(); const dn = w(Mo); const vs = w(); const x = {
    comment: ws, lineComment: w(ws), blockComment: w(ws), docComment: w(ws), name: Mt, variableName: w(Mt), typeName: bc, tagName: w(bc), propertyName: yc, attributeName: w(yc), className: w(Mt), labelName: w(Mt), namespace: w(Mt), macroName: w(Mt), literal: Et, string: ks, docString: w(ks), character: w(ks), attributeValue: w(ks), number: Ao, integer: w(Ao), float: w(Ao), bool: w(Et), regexp: w(Et), escape: w(Et), color: w(Et), url: w(Et), keyword: ot, self: w(ot), null: w(ot), atom: w(ot), unit: w(ot), modifier: w(ot), operatorKeyword: w(ot), controlKeyword: w(ot), definitionKeyword: w(ot), moduleKeyword: w(ot), operator: lt, derefOperator: w(lt), arithmeticOperator: w(lt), logicOperator: w(lt), bitwiseOperator: w(lt), compareOperator: w(lt), updateOperator: w(lt), definitionOperator: w(lt), typeOperator: w(lt), controlOperator: w(lt), punctuation: Mo, separator: w(Mo), bracket: dn, angleBracket: w(dn), squareBracket: w(dn), paren: w(dn), brace: w(dn), content: at, heading: Zt, heading1: w(Zt), heading2: w(Zt), heading3: w(Zt), heading4: w(Zt), heading5: w(Zt), heading6: w(Zt), contentSeparator: w(at), list: w(at), quote: w(at), emphasis: w(at), strong: w(at), link: w(at), monospace: w(at), strikethrough: w(at), inserted: w(), deleted: w(), changed: w(), invalid: w(), meta: vs, documentMeta: w(vs), annotation: w(vs), processingInstruction: w(vs), definition: ze.defineModifier(), constant: ze.defineModifier(), function: ze.defineModifier(), standard: ze.defineModifier(), local: ze.defineModifier(), special: ze.defineModifier(),
  }; const vy = Eo([{ tag: x.link, class: 'tok-link' }, { tag: x.heading, class: 'tok-heading' }, { tag: x.emphasis, class: 'tok-emphasis' }, { tag: x.strong, class: 'tok-strong' }, { tag: x.keyword, class: 'tok-keyword' }, { tag: x.atom, class: 'tok-atom' }, { tag: x.bool, class: 'tok-bool' }, { tag: x.url, class: 'tok-url' }, { tag: x.labelName, class: 'tok-labelName' }, { tag: x.inserted, class: 'tok-inserted' }, { tag: x.deleted, class: 'tok-deleted' }, { tag: x.literal, class: 'tok-literal' }, { tag: x.string, class: 'tok-string' }, { tag: x.number, class: 'tok-number' }, { tag: [x.regexp, x.escape, x.special(x.string)], class: 'tok-string2' }, { tag: x.variableName, class: 'tok-variableName' }, { tag: x.local(x.variableName), class: 'tok-variableName tok-local' }, { tag: x.definition(x.variableName), class: 'tok-variableName tok-definition' }, { tag: x.special(x.variableName), class: 'tok-variableName2' }, { tag: x.definition(x.propertyName), class: 'tok-propertyName tok-definition' }, { tag: x.typeName, class: 'tok-typeName' }, { tag: x.namespace, class: 'tok-namespace' }, { tag: x.className, class: 'tok-className' }, { tag: x.macroName, class: 'tok-macroName' }, { tag: x.propertyName, class: 'tok-propertyName' }, { tag: x.operator, class: 'tok-operator' }, { tag: x.comment, class: 'tok-comment' }, { tag: x.meta, class: 'tok-meta' }, { tag: x.invalid, class: 'tok-invalid' }, { tag: x.punctuation, class: 'tok-punctuation' }]); let Do; const gn = new R(); function um(i) { return v.define({ combine: i ? e => e.concat(i) : void 0 }); } const Le = class {
    ...
    findRegions(e) { const t = e.facet(Lt); if (t?.data == this.data) return [{ from: 0, to: e.doc.length }]; if (!t || !t.allowsNesting) return []; const n = []; const s = (r, o) => { if (r.prop(gn) == this.data) { n.push({ from: o, to: o + r.length }); return; } const l = r.prop(R.mounted); if (l) { if (l.tree.prop(gn) == this.data) { if (l.overlay) for (const a of l.overlay)n.push({ from: a.from + o, to: a.to + o }); else n.push({ from: o, to: o + r.length }); return; } if (l.overlay) { const a = n.length; if (s(l.tree, l.overlay[0].from + o), n.length > a) return; } } for (let a = 0; a < r.children.length; a++) { const h = r.children[a]; h instanceof J && s(h, r.positions[a] + o); } }; return s(H(e), 0), n; }

    get allowsNesting() { return !0; }
  }; Le.setState = M.define(); function vc(i, e, t) { const n = i.facet(Lt); if (!n) return null; let s = n.data; if (n.allowsNesting) for (let r = H(i).topNode; r; r = r.enter(e, t, fe.ExcludeBuffers))s = r.type.prop(gn) || s; return s; } var gt = class extends Le {
    constructor(e, t) { super(e, t), this.parser = t; }

    static define(e) { const t = um(e.languageData); return new gt(t, e.parser.configure({ props: [gn.add(n => (n.isTop ? t : void 0))] })); }
    ...
    static init(e) { const t = Math.min(3e3, e.doc.length); const n = new bn(e.facet(Lt).parser, e, [], J.empty, 0, { from: 0, to: t }, [], null); return n.work(20, t) || n.takeTree(), new Dt(n); }
  ...
  }; function xm(i, e) { for (let t = e; t; t = t.parent) if (i == t) return !0; return !1; } function wm(i) { const e = i.node; const t = e.childAfter(e.from); const n = e.lastChild; if (!t) return null; const s = i.options.simulateBreak; const r = i.state.doc.lineAt(t.from); const o = s == null || s <= r.from ? r.to : Math.min(r.to, s); for (let l = t.to; ;) { const a = e.childAfter(l); if (!a || a == n) return null; if (!a.type.isSkipped) return a.from < o ? t : null; l = a.to; } } function km(i, e, t, n, s) { const r = i.textAfter; const o = r.match(/^\s*/)[0].length; const l = n && r.slice(o, o + n.length) == n || s == i.pos + o; const a = e ? wm(i) : null; return a ? l ? i.column(a.from) : i.column(a.to) : i.baseIndent + (l ? 0 : i.unit * t); } const vm = 200; function Pc() { return $.transactionFilter.of((i) => { if (!i.docChanged || !i.isUserEvent('input.type') && !i.isUserEvent('input.complete')) return i; const e = i.startState.languageDataAt('indentOnInput', i.startState.selection.main.head); if (!e.length) return i; const t = i.newDoc; const { head: n } = i.newSelection.main; const s = t.lineAt(n); if (n > s.from + vm) return i; const r = t.sliceString(s.from, n); if (!e.some(h => h.test(r))) return i; const { state: o } = i; let l = -1; const a = []; for (const { head: h } of o.selection.ranges) { const c = o.doc.lineAt(h); if (c.from == l) continue; l = c.from; const f = Cs(o, c.from); if (f == null) continue; const u = /^\s*/.exec(c.text)[0]; const d = Ai(o, f); u != d && a.push({ from: c.from, to: c.from + u.length, insert: d }); } return a.length ? [i, { changes: a, sequential: !0 }] : i; }); } const Om = v.define(); const Wo = new R(); function Sm(i, e, t) { const n = H(i); if (n.length < t) return null; const s = n.resolveInner(t); let r = null; for (let o = s; o; o = o.parent) { if (o.to <= t || o.from > t) continue; if (r && o.from < e) break; const l = o.type.prop(Wo); if (l && (o.to < n.length - 50 || n.length == i.doc.length || !Cm(o))) { const a = l(o, i); a && a.from <= t && a.from >= e && a.to > t && (r = a); } } return r; } function Cm(i) { const e = i.lastChild; return e && e.to == i.to && e.type.isError; } function Os(i, e, t) { for (const n of i.facet(Om)) { const s = n(i, e, t); if (s) return s; } return Sm(i, e, t); } function Mc(i, e) { const t = e.mapPos(i.from, 1); const n = e.mapPos(i.to, -1); return t >= n ? void 0 : { from: t, to: n }; } const As = M.define({ map: Mc }); const xn = M.define({ map: Mc }); function Ec(i) { const e = []; for (const { head: t } of i.state.selection.ranges)e.some(n => n.from <= t && n.to >= t) || e.push(i.lineBlockAt(t)); return e; } const Xt = V.define({ create() { return A.none; }, update(i, e) { i = i.map(e.changes); for (const t of e.effects)t.is(As) && !Am(i, t.value.from, t.value.to) ? i = i.update({ add: [Lm.range(t.value.from, t.value.to)] }) : t.is(xn) && (i = i.update({ filter: (n, s) => t.value.from != n || t.value.to != s, filterFrom: t.value.from, filterTo: t.value.to })); if (e.selection) { let t = !1; const { head: n } = e.selection.main; i.between(n, n, (s, r) => { s < n && r > n && (t = !0); }), t && (i = i.update({ filterFrom: n, filterTo: n, filter: (s, r) => r <= n || s >= n })); } return i; }, provide: i => O.decorations.from(i) }); function Ss(i, e, t) { let n; let s = null; return (n = i.field(Xt, !1)) === null || n === void 0 || n.between(e, t, (r, o) => { (!s || s.from > r) && (s = { from: r, to: o }); }), s; } function Am(i, e, t) { let n = !1; return i.between(e, e, (s, r) => { s == e && r == t && (n = !0); }), n; } function Dc(i, e) { return i.field(Xt, !1) ? e : e.concat(M.appendConfig.of(Nc())); } const Tm = (i) => { for (const e of Ec(i)) { const t = Os(i.state, e.from, e.to); if (t) return i.dispatch({ effects: Dc(i.state, [As.of(t), Lc(i, t)]) }), !0; } return !1; }; const Pm = (i) => { if (!i.state.field(Xt, !1)) return !1; const e = []; for (const t of Ec(i)) { const n = Ss(i.state, t.from, t.to); n && e.push(xn.of(n), Lc(i, n, !1)); } return e.length && i.dispatch({ effects: e }), e.length > 0; }; function Lc(i, e, t = !0) { const n = i.state.doc.lineAt(e.from).number; const s = i.state.doc.lineAt(e.to).number; return O.announce.of(`${i.state.phrase(t ? 'Folded lines' : 'Unfolded lines')} ${n} ${i.state.phrase('to')} ${s}.`); } const Mm = (i) => { const { state: e } = i; const t = []; for (let n = 0; n < e.doc.length;) { const s = i.lineBlockAt(n); const r = Os(e, s.from, s.to); r && t.push(As.of(r)), n = (r ? i.lineBlockAt(r.to) : s).to + 1; } return t.length && i.dispatch({ effects: Dc(i.state, t) }), !!t.length; }; const Em = (i) => { const e = i.state.field(Xt, !1); if (!e || !e.size) return !1; const t = []; return e.between(0, i.state.doc.length, (n, s) => { t.push(xn.of({ from: n, to: s })); }), i.dispatch({ effects: t }), !0; }; const Rc = [{ key: 'Ctrl-Shift-[', mac: 'Cmd-Alt-[', run: Tm }, { key: 'Ctrl-Shift-]', mac: 'Cmd-Alt-]', run: Pm }, { key: 'Ctrl-Alt-[', run: Mm }, { key: 'Ctrl-Alt-]', run: Em }]; const Dm = { placeholderDOM: null, placeholderText: '\u2026' }; const Bc = v.define({ combine(i) { return me(i, Dm); } }); function Nc(i) { const e = [Xt, Bm]; return i && e.push(Bc.of(i)), e; } var Lm = A.replace({ widget: new class extends Ae {toDOM(i) { const { state: e } = i; const t = e.facet(Bc); const n = (r) => { const o = i.lineBlockAt(i.posAtDOM(r.target)); const l = Ss(i.state, o.from, o.to); l && i.dispatch({ effects: xn.of(l) }), r.preventDefault(); }; if (t.placeholderDOM) return t.placeholderDOM(i, n); const s = document.createElement('span'); return s.textContent = t.placeholderText, s.setAttribute('aria-label', e.phrase('folded code')), s.title = e.phrase('unfold'), s.className = 'cm-foldPlaceholder', s.onclick = n, s; }}() }); const Rm = {
    ...
    const e = { ...Rm, ...i }; const t = new mn(e, !0); const n = new mn(e, !1); const s = q.fromClass(class {
      ...
      buildMarkers(o) { const l = new Ee(); for (const a of o.viewportLineBlocks) { const h = Ss(o.state, a.from, a.to) ? n : Os(o.state, a.from, a.to) ? t : null; h && l.add(a.from, a.from, h); } return l.finish(); }
    }); const { domEventHandlers: r } = e; return [s, ms({
      class: 'cm-foldGutter', markers(o) { let l; return ((l = o.plugin(s)) === null || l === void 0 ? void 0 : l.markers) || I.empty; }, initialSpacer() { return new mn(e, !1); }, domEventHandlers: { ...r, click: (o, l, a) => { if (r.click && r.click(o, l, a)) return !0; const h = Ss(o.state, l.from, l.to); if (h) return o.dispatch({ effects: xn.of(h) }), !0; const c = Os(o.state, l.from, l.to); return c ? (o.dispatch({ effects: As.of(c) }), !0) : !1; } },
    }), Nc()];
  } var Bm = O.baseTheme({
    '.cm-foldPlaceholder': {
    ...
    constructor(e, t) { let n; function s(o) { const l = Ie.newName(); return (n || (n = Object.create(null)))[`.${l}`] = o, l; } const r = t.scope; this.scope = r instanceof Le ? o => o.prop(gn) == r.data : r ? o => o == r : void 0, this.style = Eo(e.map(o => ({ tag: o.tag, class: o.class || s({ ...o, tag: null }) })), { all: typeof t.all === 'string' ? t.all : t.all ? s(t.all) : void 0 }).style, this.module = n ? new Ie(n) : null, this.themeType = t.themeType; }
    ...
    addChanges(e, t, n, s, r) { let o = this.done; const l = o[o.length - 1]; return l && l.changes && !l.changes.empty && e.changes && (!n || cg.test(n)) && (!l.selectionsAfter.length && t - this.prevTime < s && rg(l.changes, e.changes) || n == 'input.type.compose') ? o = Ts(o, o.length - 1, r, new ye(e.changes.compose(l.changes), af(e.effects, l.effects), l.mapped, l.startSelection, Ve)) : o = Ts(o, o.length, r, e), new We(o, Ve, t, n); }
  ...
  }; typeof Symbol < 'u' && (Nt.prototype[Symbol.iterator] = function () { return this; }); const Uf = { from: -1, to: -1, match: /.*/.exec('') }; const tl = `gm${/x/.unicode == null ? '' : 'u'}`; const Is = class {
    constructor(e, t, n, s = 0, r = e.length) { if (this.to = r, this.curLine = '', this.done = !1, this.value = Uf, /\\[sWDnr]|\n|\r|\[\^/.test(t)) return new Fs(e, t, n, s, r); this.re = new RegExp(t, tl + (n?.ignoreCase ? 'i' : '')), this.iter = e.iter(); const o = e.lineAt(s); this.curLineStart = o.from, this.matchPos = s, this.getLine(this.curLineStart); }
  ...
  }; typeof Symbol < 'u' && (Is.prototype[Symbol.iterator] = Fs.prototype[Symbol.iterator] = function () { return this; }); function _g(i) { try { return new RegExp(i, tl), !0; } catch { return !1; } } function Xo(i) { const e = U('input', { class: 'cm-textfield', name: 'line' }); const t = U('form', { class: 'cm-gotoLine', onkeydown: (s) => { s.keyCode == 27 ? (s.preventDefault(), i.dispatch({ effects: zs.of(!1) }), i.focus()) : s.keyCode == 13 && (s.preventDefault(), n()); }, onsubmit: (s) => { s.preventDefault(), n(); } }, U('label', i.state.phrase('Go to line'), ': ', e), ' ', U('button', { class: 'cm-button', type: 'submit' }, i.state.phrase('go'))); function n() { const s = /^([+-])?(\d+)?(:\d+)?(%)?$/.exec(e.value); if (!s) return; const { state: r } = i; const o = r.doc.lineAt(r.selection.main.head); const [, l, a, h, c] = s; const f = h ? +h.slice(1) : 0; let u = a ? +a : o.number; if (a && c) { let p = u / 100; l && (p = p * (l == '-' ? -1 : 1) + o.number / r.doc.lines), u = Math.round(r.doc.lines * p); } else a && l && (u = u * (l == '-' ? -1 : 1) + o.number); const d = r.doc.line(Math.max(1, Math.min(r.doc.lines, u))); i.dispatch({ effects: zs.of(!1), selection: m.cursor(d.from + Math.max(0, Math.min(f, d.length))), scrollIntoView: !0 }), i.focus(); } return { dom: t }; } var zs = M.define(); const Wf = V.define({ create() { return !0; }, update(i, e) { for (const t of e.effects)t.is(zs) && (i = t.value); return i; }, provide: i => pt.from(i, e => (e ? Xo : null)) }); const jg = (i) => { let e = jt(i, Xo); if (!e) { const t = [zs.of(!0)]; i.state.field(Wf, !1) == null && t.push(M.appendConfig.of([Wf, Gg])), i.dispatch({ effects: t }), e = jt(i, Xo); } return e && e.dom.querySelector('input').focus(), !0; }; var Gg = O.baseTheme({ '.cm-panel.cm-gotoLine': { padding: '2px 6px 4px', '& label': { fontSize: '80%' } } }); const Zg = {
...
` : n == 'r' ? '\r' : n == 't' ? '	' : '\\'));
  ...
  }; const Ws = class {constructor(e) { this.spec = e; }}; function Pi(i, e, t, n) { return new Nt(e, i.unquoted, t, n, i.caseSensitive ? void 0 : s => s.toLowerCase()); } var Ko = class extends Ws {
  ...
  }; function Mi(i, e, t, n) { return new Is(e, i.search, i.caseSensitive ? void 0 : { ignoreCase: !0 }, t, n); } var Jo = class extends Ws {
  ...
  }; const vn = M.define(); const nl = M.define(); const Bt = V.define({ create(i) { return new kn(Yo(i).create(), null); }, update(i, e) { for (const t of e.effects)t.is(vn) ? i = new kn(t.value.create(), i.panel) : t.is(nl) && (i = new kn(i.query, t.value ? sl : null)); return i; }, provide: i => pt.from(i, e => e.panel) }); var kn = class {constructor(e, t) { this.query = e, this.panel = t; }}; const n0 = A.mark({ class: 'cm-searchMatch' }); const s0 = A.mark({ class: 'cm-searchMatch cm-searchMatch-selected' }); const r0 = q.fromClass(class {
  ...
  }, { decorations: i => i.decorations }); function On(i) { return (e) => { const t = e.state.field(Bt, !1); return t && t.query.spec.valid ? i(e, t) : Gf(e); }; } const Hs = On((i, { query: e }) => {
  ...
  }); const o0 = On((i, { query: e }) => { const t = e.matchAll(i.state.doc, 1e3); return !t || !t.length ? !1 : (i.dispatch({ selection: m.create(t.map(n => m.range(n.from, n.to))), userEvent: 'select.search.matches' }), !0); }); const l0 = ({ state: i, dispatch: e }) => { const t = i.selection; if (t.ranges.length > 1 || t.main.empty) return !1; const { from: n, to: s } = t.main; const r = []; let o = 0; for (let l = new Nt(i.doc, i.sliceDoc(n, s)); !l.next().done;) { if (r.length > 1e3) return !1; l.value.from == n && (o = r.length), r.push(m.range(l.value.from, l.value.to)); } return e(i.update({ selection: m.create(r, o), userEvent: 'select.search.matches' })), !0; }; const qf = On((i, { query: e }) => {
  ...
  }); const a0 = On((i, { query: e }) => { if (i.state.readOnly) return !1; const t = e.matchAll(i.state.doc, 1e9).map((n) => { const { from: s, to: r } = n; return { from: s, to: r, insert: e.getReplacement(n) }; }); return t.length ? (i.dispatch({ changes: t, userEvent: 'input.replace.all' }), !0) : !1; }); function sl(i) { return i.state.facet(il).createPanel(i); } function Yo(i, e) { let t; const n = i.selection.main; const s = n.empty || n.to > n.from + 100 ? '' : i.sliceDoc(n.from, n.to); const r = (t = e?.caseSensitive) !== null && t !== void 0 ? t : i.facet(il).caseSensitive; return e && !s ? e : new Vs({ search: s.replace(/\n/g, '\\n'), caseSensitive: r }); } var Gf = (i) => { const e = i.state.field(Bt, !1); if (e && e.panel) { const t = jt(i, sl); if (!t) return !1; const n = t.dom.querySelector('[name=search]'); if (n != i.root.activeElement) { const s = Yo(i.state, e.query.spec); s.valid && i.dispatch({ effects: vn.of(s) }), n.focus(), n.select(); } } else i.dispatch({ effects: [nl.of(!0), e ? vn.of(Yo(i.state, e.query.spec)) : M.appendConfig.of(c0)] }); return !0; }; const Zf = (i) => { const e = i.state.field(Bt, !1); if (!e || !e.panel) return !1; const t = jt(i, sl); return t && t.dom.contains(i.root.activeElement) && i.focus(), i.dispatch({ effects: nl.of(!1) }), !0; }; const Qf = [{ key: 'Mod-f', run: Gf, scope: 'editor search-panel' }, {
    key: 'F3', run: Hs, shift: qs, scope: 'editor search-panel', preventDefault: !0,
  }, {
    key: 'Mod-g', run: Hs, shift: qs, scope: 'editor search-panel', preventDefault: !0,
    ...
    constructor(e) {
      ...
      } this.dom = U('div', { onkeydown: s => this.keydown(s), class: 'cm-search' }, [this.searchField, n('next', () => Hs(e), [qe(e, 'next')]), n('prev', () => qs(e), [qe(e, 'previous')]), n('select', () => o0(e), [qe(e, 'all')]), U('label', null, [this.caseField, qe(e, 'match case')]), U('label', null, [this.reField, qe(e, 'regexp')]), ...e.state.readOnly ? [] : [U('br'), this.replaceField, n('replace', () => qf(e), [qe(e, 'replace')]), n('replaceAll', () => a0(e), [qe(e, 'replace all')]), U('button', {
    ...
    keydown(e) { Gh(this.view, e, 'search-panel') ? e.preventDefault() : e.keyCode == 13 && e.target == this.searchField ? (e.preventDefault(), (e.shiftKey ? qs : Hs)(this.view)) : e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), qf(this.view)); }
  ...
  }; function qe(i, e) { return i.state.phrase(e); } const Ns = 30; const $s = /[\s\.,:;?!]/; function rl(i, { from: e, to: t }) { const n = i.state.doc.lineAt(e).from; const s = i.state.doc.lineAt(t).to; const r = Math.max(n, e - Ns); const o = Math.min(s, t + Ns); let l = i.state.sliceDoc(r, o); if (r != n) { for (let a = 0; a < Ns; a++) if (!$s.test(l[a + 1]) && $s.test(l[a])) { l = l.slice(a); break; } } if (o != s) { for (let a = l.length - 1; a > l.length - Ns; a--) if (!$s.test(l[a - 1]) && $s.test(l[a])) { l = l.slice(0, a); break; } } return O.announce.of(`${i.state.phrase('current match')}. ${l} ${i.state.phrase('on line')} ${i.state.doc.lineAt(e).number}`); } const h0 = O.baseTheme({
    '.cm-panel.cm-search': {
      padding: '2px 6px 4px',
      position: 'relative',
      '& [name=close]': {
  ...
  }); var c0 = [Bt, Ye.lowest(r0), h0]; const _s = class {
    ...
    handleUserEvent(e, t, n) { let s; const r = e.changes.mapPos(this.from); const o = e.changes.mapPos(this.to, 1); const l = $t(e.state); if ((this.explicitPos < 0 ? l <= r : l < this.from) || l > o || t == 'delete' && $t(e.startState) == this.from) return new xe(this.source, t == 'input' && n.activateOnTyping ? 1 : 0); const a = this.explicitPos < 0 ? -1 : e.changes.mapPos(this.explicitPos); let h; return S0(this.result.validFor, e.state, r, o) ? new Yt(this.source, a, this.result, r, o) : this.result.update && (h = this.result.update(this.result, r, o, new _s(e.state, l, a >= 0))) ? new Yt(this.source, a, h, h.from, (s = h.to) !== null && s !== void 0 ? s : $t(e.state)) : new xe(this.source, 1, a); }
    ...
    startQuery(i) { const { state: e } = this.view; const t = $t(e); const n = new _s(e, t, i.explicitPos == t); const s = new cl(i, n); this.running.push(s), Promise.resolve(i.source(n)).then((r) => { s.context.aborted || (s.done = r || null, this.scheduleAccept()); }, (r) => { this.view.dispatch({ effects: dl.of(null) }), ge(this.view.state, r); }); }
  ...
  }); const fl = class {constructor(e, t, n, s) { this.field = e, this.line = t, this.from = n, this.to = s; }}; var Sn = class {
    ...
    instantiate(e, t) { const n = []; const s = [t]; const r = e.doc.lineAt(t); const o = /^\s*/.exec(r.text)[0]; for (let a of this.lines) { if (n.length) { let h = o; const c = /^\t*/.exec(a)[0].length; for (let f = 0; f < c; f++)h += e.facet(Ci); s.push(t + h.length - c), a = h + a.slice(c); }n.push(a), t += a.length + 1; } const l = this.fieldPositions.map(a => new Sn(a.field, s[a.line] + a.from, s[a.line] + a.to)); return { text: n, ranges: l }; }
  ...
  }; const Tn = M.define({ map(i, e) { return i && i.map(e); } }); const R0 = M.define(); const An = V.define({ create() { return null; }, update(i, e) { for (const t of e.effects) { if (t.is(Tn)) return t.value; if (t.is(R0) && i) return new It(i.ranges, t.value); } return i && e.docChanged && (i = i.map(e.changes)), i && e.selection && !i.selectionInsideField(e.selection) && (i = null), i; }, provide: i => O.decorations.from(i, e => (e ? e.deco : A.none)) }); function pl(i, e) { return m.create(i.filter(t => t.field == e).map(t => m.range(t.from, t.to))); } function cu(i) { const e = Cn.parse(i); return (t, n, s, r) => { const { text: o, ranges: l } = e.instantiate(t.state, s); const a = { changes: { from: s, to: r, insert: z.of(o) } }; if (l.length && (a.selection = pl(l, 0)), l.length > 1) { const h = new It(l, 0); const c = a.effects = [Tn.of(h)]; t.state.field(An, !1) === void 0 && c.push(M.appendConfig.of([An, F0, z0, hu])); }t.dispatch(t.state.update(a)); }; } function fu(i) { return ({ state: e, dispatch: t }) => { const n = e.field(An, !1); if (!n || i < 0 && n.active == 0) return !1; const s = n.active + i; const r = i > 0 && !n.ranges.some(o => o.field == s + i); return t(e.update({ selection: pl(n.ranges, s), effects: Tn.of(r ? null : new It(n.ranges, s)) })), !0; }; } const B0 = ({ state: i, dispatch: e }) => (i.field(An, !1) ? (e(i.update({ effects: Tn.of(null) })), !0) : !1); const N0 = fu(1); const $0 = fu(-1); const I0 = [{ key: 'Tab', run: N0, shift: $0 }, { key: 'Escape', run: B0 }]; const iu = v.define({ combine(i) { return i.length ? i[0] : I0; } }); var F0 = Ye.highest(Pe.compute([iu], i => i.facet(iu))); var z0 = O.domEventHandlers({ mousedown(i, e) { const t = e.state.field(An, !1); let n; if (!t || (n = e.posAtCoords({ x: i.clientX, y: i.clientY })) == null) return !1; const s = t.ranges.find(r => r.from <= n && r.to >= n); return !s || s.field == t.active ? !1 : (e.dispatch({ selection: pl(t.ranges, s.field), effects: Tn.of(t.ranges.some(r => r.field > s.field) ? new It(t.ranges, s.field) : null) }), !0); } }); const Gs = { brackets: ['(', '[', '{', "'", '"'], before: ')]}:;>' }; const Kt = M.define({ map(i, e) { const t = e.mapPos(i, -1, oe.TrackAfter); return t ?? void 0; } }); const ml = M.define({ map(i, e) { return e.mapPos(i); } }); const gl = new class extends je {}(); gl.startSide = 1; gl.endSide = -1; const uu = V.define({ create() { return I.empty; }, update(i, e) { if (e.selection) { const t = e.state.doc.lineAt(e.selection.main.head).from; const n = e.startState.doc.lineAt(e.startState.selection.main.head).from; t != e.changes.mapPos(n, -1) && (i = I.empty); }i = i.map(e.changes); for (const t of e.effects)t.is(Kt) ? i = i.update({ add: [gl.range(t.value, t.value + 1)] }) : t.is(ml) && (i = i.update({ filter: n => n != t.value })); return i; } }); function du() { return [W0, uu]; } const ol = '()[]{}<>'; function pu(i) { for (let e = 0; e < ol.length; e += 2) if (ol.charCodeAt(e) == i) return ol.charAt(e + 1); return ji(i < 128 ? i : i + 1); } function mu(i, e) { return i.languageDataAt('closeBrackets', e)[0] || Gs; } const V0 = typeof navigator === 'object' && /Android\b/.test(navigator.userAgent); var W0 = O.inputHandler.of((i, e, t, n) => { if ((V0 ? i.composing : i.compositionStarted) || i.state.readOnly) return !1; const s = i.state.selection.main; if (n.length > 2 || n.length == 2 && Ce(ae(n, 0)) == 1 || e != s.from || t != s.to) return !1; const r = q0(i.state, n); return r ? (i.dispatch(r), !0) : !1; }); const H0 = ({ state: i, dispatch: e }) => { if (i.readOnly) return !1; const n = mu(i, i.selection.main.head).brackets || Gs.brackets; let s = null; const r = i.changeByRange((o) => { if (o.empty) { const l = U0(i.doc, o.head); for (const a of n) if (a == l && Zs(i.doc, o.head) == pu(ae(a, 0))) return { changes: { from: o.head - a.length, to: o.head + a.length }, range: m.cursor(o.head - a.length), userEvent: 'delete.backward' }; } return { range: s = o }; }); return s || e(i.update(r, { scrollIntoView: !0 })), !s; }; const gu = [{ key: 'Backspace', run: H0 }]; function q0(i, e) { const t = mu(i, i.selection.main.head); const n = t.brackets || Gs.brackets; for (const s of n) { const r = pu(ae(s, 0)); if (e == s) return r == s ? G0(i, s, n.indexOf(s + s + s) > -1) : _0(i, s, r, t.before || Gs.before); if (e == r && bu(i, i.selection.main.from)) return j0(i, s, r); } return null; } function bu(i, e) { let t = !1; return i.field(uu).between(0, i.doc.length, (n) => { n == e && (t = !0); }), t; } function Zs(i, e) { const t = i.sliceString(e, e + 2); return t.slice(0, Ce(ae(t, 0))); } function U0(i, e) { const t = i.sliceString(e - 2, e); return Ce(ae(t, 0)) == t.length ? t : t.slice(1); } function _0(i, e, t, n) { let s = null; const r = i.changeByRange((o) => { if (!o.empty) return { changes: [{ insert: e, from: o.from }, { insert: t, from: o.to }], effects: Kt.of(o.to + e.length), range: m.range(o.anchor + e.length, o.head + e.length) }; const l = Zs(i.doc, o.head); return !l || /\s/.test(l) || n.indexOf(l) > -1 ? { changes: { insert: e + t, from: o.head }, effects: Kt.of(o.head + e.length), range: m.cursor(o.head + e.length) } : { range: s = o }; }); return s ? null : i.update(r, { scrollIntoView: !0, userEvent: 'input.type' }); } function j0(i, e, t) { let n = null; const s = i.selection.ranges.map(r => (r.empty && Zs(i.doc, r.head) == t ? m.cursor(r.head + t.length) : n = r)); return n ? null : i.update({ selection: m.create(s, i.selection.mainIndex), scrollIntoView: !0, effects: i.selection.ranges.map(({ from: r }) => ml.of(r)) }); } function G0(i, e, t) { let n = null; const s = i.changeByRange((r) => { if (!r.empty) return { changes: [{ insert: e, from: r.from }, { insert: e, from: r.to }], effects: Kt.of(r.to + e.length), range: m.range(r.anchor + e.length, r.head + e.length) }; const o = r.head; const l = Zs(i.doc, o); if (l == e) { if (nu(i, o)) return { changes: { insert: e + e, from: o }, effects: Kt.of(o + e.length), range: m.cursor(o + e.length) }; if (bu(i, o)) { const a = t && i.sliceDoc(o, o + e.length * 3) == e + e + e; return { range: m.cursor(o + e.length * (a ? 3 : 1)), effects: ml.of(o) }; } } else { if (t && i.sliceDoc(o - 2 * e.length, o) == e + e && nu(i, o - 2 * e.length)) return { changes: { insert: e + e + e + e, from: o }, effects: Kt.of(o + e.length), range: m.cursor(o + e.length) }; if (i.charCategorizer(o)(l) != le.Word) { const a = i.sliceDoc(o - 1, o); if (a != e && i.charCategorizer(o)(a) != le.Word && !Z0(i, o, e)) return { changes: { insert: e + e, from: o }, effects: Kt.of(o + e.length), range: m.cursor(o + e.length) }; } } return { range: n = r }; }); return n ? null : i.update(s, { scrollIntoView: !0, userEvent: 'input.type' }); } function nu(i, e) { const t = H(i).resolveInner(e + 1); return t.parent && t.from == e; } function Z0(i, e, t) { let n = H(i).resolveInner(e, -1); for (let s = 0; s < 5; s++) { if (i.sliceDoc(n.from, n.from + t.length) == t) return !0; const r = n.to == e && n.parent; if (!r) break; n = r; } return !1; } function yu(i = {}) { return [Xe, ei.of(i), E0, Q0, hu]; } const bl = [{ key: 'Ctrl-Space', run: A0 }, { key: 'Escape', run: T0 }, { key: 'ArrowDown', run: Us(!0) }, { key: 'ArrowUp', run: Us(!1) }, { key: 'PageDown', run: Us(!0, 'page') }, { key: 'PageUp', run: Us(!1, 'page') }, { key: 'Enter', run: C0 }]; var Q0 = Ye.highest(Pe.computeN([ei], i => (i.facet(ei).defaultKeymap ? [bl] : []))); const xl = class {constructor(e, t, n) { this.from = e, this.to = t, this.diagnostic = n; }}; var yt = class {
  ...
  }; function Di(i, e = null, t = 0) { let n = null; return i.between(t, 1e9, (s, r, { spec: o }) => { if (!(e && o.diagnostic != e)) return n = new xl(s, r, o.diagnostic), !1; }), n; } function wu(i, e) { return !!(i.effects.some(t => t.is(Ri)) || i.changes.touchesRange(e.pos)); } function ku(i, e) { return i.field(Re, !1) ? e : e.concat(M.appendConfig.of([Re, O.decorations.compute([Re], (t) => { const { selected: n, panel: s } = t.field(Re); return !n || !s || n.from == n.to ? A.none : A.set([K0.range(n.from, n.to)]); }), oc(J0, { hideOn: wu }), ib])); } function X0(i, e) { return { effects: ku(i, [Ri.of(e)]) }; } var Ri = M.define(); const vl = M.define(); const vu = M.define(); var Re = V.define({ create() { return new yt(A.none, null, null); }, update(i, e) { if (e.docChanged) { const t = i.diagnostics.map(e.changes); let n = null; if (i.selected) { const s = e.changes.mapPos(i.selected.from, 1); n = Di(t, i.selected.diagnostic, s) || Di(t, null, s); }i = new yt(t, i.panel, n); } for (const t of e.effects)t.is(Ri) ? i = yt.init(t.value, i.panel, e.state) : t.is(vl) ? i = new yt(i.diagnostics, t.value ? Li.open : null, i.selected) : t.is(vu) && (i = new yt(i.diagnostics, i.panel, t.value)); return i; }, provide: i => [pt.from(i, e => e.panel), O.decorations.from(i, e => e.diagnostics)] }); var K0 = A.mark({ class: 'cm-lintRange cm-lintRange-active' }); function J0(i, e, t) {
  ...
  }; const Xs = class {constructor(e, t) { this.diagnostic = t, this.id = `item_${Math.floor(Math.random() * 4294967295).toString(16)}`, this.dom = Au(e, t, !0), this.dom.id = this.id, this.dom.setAttribute('role', 'option'); }}; var Li = class {
    constructor(e) {
    ...
    update() {
      const { diagnostics: e, selected: t } = this.view.state.field(Re); let n = 0; let s = !1; let r = null; for (e.between(0, this.view.state.doc.length, (o, l, { spec: a }) => { let h = -1; let c; for (let f = n; f < this.items.length; f++) if (this.items[f].diagnostic == a.diagnostic) { h = f; break; }h < 0 ? (c = new Xs(this.view, a.diagnostic), this.items.splice(n, 0, c), s = !0) : (c = this.items[h], h > n && (this.items.splice(n, h - n), s = !0)), t && c.diagnostic == t.diagnostic ? c.dom.hasAttribute('aria-selected') || (c.dom.setAttribute('aria-selected', 'true'), r = c) : c.dom.hasAttribute('aria-selected') && c.dom.removeAttribute('aria-selected'), n++; }); n < this.items.length && !(this.items.length == 1 && this.items[0].diagnostic.from < 0);)s = !0, this.items.pop(); this.items.length == 0 && (this.items.push(new Xs(this.view, {
  ...
  }; function Qs(i, e = 'viewBox="0 0 40 40"') { return `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" ${e}>${encodeURIComponent(i)}</svg>')`; } function yl(i) { return Qs(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${i}" fill="none" stroke-width=".7"/>`, 'width="6" height="3"'); } var ib = O.baseTheme({
    '.cm-diagnostic': {
  ...
  }; function nb(i, e) { const t = (n) => { const s = e.getBoundingClientRect(); if (!(n.clientX > s.left - 10 && n.clientX < s.right + 10 && n.clientY > s.top - 10 && n.clientY < s.bottom + 10)) { for (let r = n.target; r; r = r.parentNode) if (r.nodeType == 1 && r.classList.contains('cm-tooltip-lint')) return; window.removeEventListener('mousemove', t), i.state.field(Pu) && i.dispatch({ effects: Ol.of(null) }); } }; window.addEventListener('mousemove', t); } function sb(i, e, t) { function n() { const o = i.elementAtHeight(e.getBoundingClientRect().top + 5 - i.documentTop); i.coordsAtPos(o.from) && i.dispatch({ effects: Ol.of({ pos: o.from, above: !1, create() { return { dom: Ou(i, t), getCoords: () => e.getBoundingClientRect() }; } }) }), e.onmouseout = e.onmousemove = null, nb(i, e); } const { hoverTime: s } = i.state.facet(Js); let r = setTimeout(n, s); e.onmouseout = () => { clearTimeout(r), e.onmouseout = e.onmousemove = null; }, e.onmousemove = () => { clearTimeout(r), r = setTimeout(n, s); }; } function rb(i, e) { const t = Object.create(null); for (const s of e) { const r = i.lineAt(s.from); (t[r.from] || (t[r.from] = [])).push(s); } const n = []; for (const s in t)n.push(new kl(t[s]).range(+s)); return I.of(n, !0); } const ob = ms({ class: 'cm-gutter-lint', markers: i => i.state.field(Tu) }); var Tu = V.define({ create() { return I.empty; }, update(i, e) { i = i.map(e.changes); const t = e.state.facet(Js).markerFilter; for (const n of e.effects) if (n.is(Ri)) { let s = n.value; t && (s = t(s || [])), i = rb(e.state.doc, s.slice(0)); } return i; } }); var Ol = M.define(); var Pu = V.define({ create() { return null; }, update(i, e) { return i && e.docChanged && (i = wu(e, i) ? null : ({ ...i, pos: e.changes.mapPos(i.pos) })), e.effects.reduce((t, n) => (n.is(Ol) ? n.value : t), i); }, provide: i => bi.from(i) }); const lb = O.baseTheme({
    '.cm-gutter-lint': { width: '1.4em', '& .cm-gutterElement': { padding: '.2em' } }, '.cm-lint-marker': { width: '1em', height: '1em' }, '.cm-lint-marker-info': { content: Qs('<path fill="#aaf" stroke="#77e" stroke-width="6" stroke-linejoin="round" d="M5 5L35 5L35 35L5 35Z"/>') }, '.cm-lint-marker-warning': { content: Qs('<path fill="#fe8" stroke="#fd7" stroke-width="6" stroke-linejoin="round" d="M20 6L37 35L3 35Z"/>') }, '.cm-lint-marker-error:before': { content: Qs('<circle cx="20" cy="20" r="15" fill="#f87" stroke="#f43" stroke-width="6"/>') },
  }); var Js = v.define({ combine(i) { return me(i, { hoverTime: 300, markerFilter: null, tooltipFilter: null }); } }); function Bi(i = {}) { return [Js.of(i), Tu, ob, lb, Pu]; } const Mu = [fc(), uc(), tc(), rf(), $c(), Xh(), ec(), $.allowMultipleSelections.of(!0), Pc(), Fc(zc, { fallback: !0 }), qc(), du(), yu(), nc(), sc(), ic(), jf(), Pe.of([...gu, ...If, ...Qf, ...cf, ...Rc, ...bl, ...Su])]; var Ii = class {
    ...
    static start(e, t, n = 0) { const s = e.parser.context; return new Ii(e, [], t, n, n, 0, [], 0, s ? new er(s, s.start) : null, 0, null); }
    ...
    split() { let e = this; let t = e.buffer.length; for (;t > 0 && e.buffer[t - 2] > e.reducePos;)t -= 4; const n = e.buffer.slice(t); const s = e.bufferBase + t; for (;e && s == e.bufferBase;)e = e.parent; return new Ii(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, n, s, this.curContext, this.lookAhead, e); }
    ...
    static create(e, t = e.bufferBase + e.buffer.length) { return new Fi(e, t, t - e.bufferBase); }
    ...
    fork() { return new Fi(this.stack, this.pos, this.index); }
  }; const Ni = class {constructor() { this.start = -1, this.value = -1, this.end = -1, this.extended = -1, this.lookAhead = 0, this.mask = 0, this.context = 0; }}; const Du = new Ni(); const Tl = class {
    ...
    constructor(e, t) { this.stream = t, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = e.tokenizers.map(n => new Ni()); }

    getActions(e) { let t = 0; let n = null; const { parser: s } = e.p; const { tokenizers: r } = s; const o = s.stateSlot(e.state, 3); const l = e.curContext ? e.curContext.hash : 0; let a = 0; for (let h = 0; h < r.length; h++) { if ((1 << h & o) == 0) continue; const c = r[h]; const f = this.tokens[h]; if (!(n && !c.fallback) && ((c.contextual || f.start != e.pos || f.mask != o || f.context != l) && (this.updateCachedToken(f, c, e), f.mask = o, f.context = l), f.lookAhead > f.end + 25 && (a = Math.max(f.lookAhead, a)), f.value != 0)) { const u = t; if (f.extended > -1 && (t = this.addActions(e, f.extended, f.end, t)), t = this.addActions(e, f.value, f.end, t), !c.extend && (n = f, t > u)) break; } } for (;this.actions.length > t;) this.actions.pop(); return a && e.setLookAhead(a), !n && e.pos == this.stream.end && (n = new Ni(), n.value = e.p.parser.eofTerm, n.start = n.end = e.pos, t = this.addActions(e, n.value, n.end, t)), this.mainToken = n, this.actions; }

    getMainToken(e) {
      if (this.mainToken) return this.mainToken; const t = new Ni(); const
    ...
    stackToTree(e) {
      return e.close(), J.build({
        buffer: Fi.create(e), nodeSet: this.parser.nodeSet, topID: this.topTerm, maxBufferLength: this.parser.bufferLength, reused: this.reused, start: this.ranges[0].from, length: e.pos - this.ranges[0].from, minRepeatType: this.parser.minRepeatTerm,
      });
    }
...
`)); try { const a = e.serialize(); if (!a) return; e.editor._value = a, e.editor.emitUpdateEvent(l); } catch (a) {}
          } else { const r = s.transactions[0]; if (r) { const o = r.effects.filter(l => l.is(Ri)); if (o) { const l = o.reduce((a, h) => { const c = h.value.filter(u => u.severity === 'error'); const f = h.value.filter(u => u.severity === 'info'); if (c.length) { a.valid = !1; for (const u of c)a.errors.push(u == null ? void 0 : u.message); } return f.length && !a.errors.length && (a.valid = !0), a; }, { valid: e.editor.valid, errors: [] }); if (e.editor.valid = l.valid, l.valid) { e.editor.dispatchEvent(new CustomEvent('valid', { composed: !0, bubbles: !0 })); return; }e.editor.dispatchEvent(new CustomEvent('invalid', { detail: l.errors, composed: !0, bubbles: !0 })); } } }
        }
...
=>=D>`),
    ...
    getExtensions() { return [ed(), Ks(Qb()), Pe.of(Kb), Bi()]; }
    ...
    setFromValue(e) { if (!e) return ''; if (e instanceof NodeList) { const t = []; return e.forEach(n => t.push(Mn(n))), t.join(''); } if (e instanceof Element) return Mn(e); if (typeof e !== 'string') throw new Error('cannot set value'); return e; }
  }; function Vl(i, e) {
...
$2`), i = i.replace(/unit=\"line\"\/>\s(\w)/g, 'unit="line"/>$1'), i = i.replace(/ ?∙ ?/g, ' <g type="interpunct">\u25B4</g> '), i = i.replace(/ ?𐆖 ?/g, ' <g type="denarius"/> '), i = i.replace(/❦/g, ' <g type="hedera">\u2766</g> '), i = i.replace(/\s\s/g, ' '), i = i.replace(/ {2,99}/g, ''), i;
    ...
    const n = `<ab>${Vl(i, e)}
</ab>`; const r = new DOMParser().parseFromString(n, 'application/xml'); return r.firstElementChild ? Mn(r.firstElementChild) : '';
  } const Yb = (i, e) => (t) => {
...
`), e); return i.content = s, i.mode = 'leiden_plus', !0;
    ...
    getExtensions() { return [Pe.of(ey), Bi()]; }
...
${Vl(n, this._sourceType)}
    ...
    configure() { switch (this._mode) { case 'default': case 'edcs': case 'phi': this._config = new lr(this, this._mode); break; case 'leiden_plus': this._config = new or(this); break; default: this._config = new Vi(this, this.namespace); break; } }
  ...
  }; window.customElements.define('jinn-codemirror', En); const Hl = class extends En {
    ...
    configure() { const t = this.hasAttribute('check-namespace'); this._config = new Vi(this, this.namespace, t, this.unwrap); }
    ...
    setValue(t) { let n; let s; if (!this.unwrap) return super.setValue(t); if (((n = this._config) == null ? void 0 : n.setFromValue(this._wrapper)) === ((s = this._config) == null ? void 0 : s.setFromValue(t))) return console.debug('value unchanged'), !1; if (t || (this._wrapper = null), !(t instanceof Element)) throw new Error('Value is not a node'); return this._wrapper = t, this._value = t.childNodes, !0; }
