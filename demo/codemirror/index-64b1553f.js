...
class r {
  constructor(t = {}) {
    ...
    (this.deserialize = t.deserialize
        || (() => {
...
class n {
  ...
  static define(t) {
    const e = t.props && t.props.length ? Object.create(null) : i;
    const s = (t.top ? 1 : 0) | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0);
    const r = new n(t.name || '', e, t.id, s);
    if (t.props) {
  ...
  static match(t) {
    ...
    for (const s in t) for (const r of s.split(' ')) e[r] = t[s];
    return (t) => {
      for (let s = t.prop(r.group), i = -1; i < (s ? s.length : 0); i++) {
        const r = e[i < 0 ? t.name : s[i]];
        if (r) return r;
      }
    };
  }
...
class u {
  constructor(t, e, s, r, i) {
    if (
      ...
      for (const [t, e] of i) this.props[typeof t === 'number' ? t : t.id] = e;
    }
  }

  toString() {
    const t = this.prop(r.mounted);
  ...
  cursorAt(t, e = 0, s = 0) {
    const r = o.get(this) || this.topNode;
    const i = new y(r);
  ...
  resolve(t, e = 0) {
    const s = g(o.get(this) || this.topNode, t, e, !1);
    return o.set(this, s), s;
  }

  resolveInner(t, e = 0) {
    const s = g(a.get(this) || this.topNode, t, e, !0);
    return a.set(this, s), s;
  }

  iterate(t) {
    const {
      enter: e, leave: s, from: r = 0, to: i = this.length,
    } = t;
  ...
  get propValues() {
    const t = [];
    if (this.props) for (const e in this.props) t.push([+e, this.props[e]]);
    return t;
  }
...
class c {
  ...
  childString(t) {
    ...
    const s = this.buffer[t + 3];
    const r = this.set.types[e];
    let i = r.name;
  ...
  slice(t, e, s, r) {
    const i = this.buffer;
    const n = new Uint16Array(e - t);
    for (let r = t, h = 0; r < e;) (n[h++] = i[r++]), (n[h++] = i[r++] - s), (n[h++] = i[r++] - s), (n[h++] = i[r++] - t);
...
function g(t, e, s, r) {
  for (
    ...
    const e = !r && t instanceof k && t.index < 0 ? null : t.parent;
    if (!e) return t;
    t = e;
  }
  const n = r ? 0 : l.IgnoreOverlays;
  if (r) {
    for (let r = t, h = r.parent; h; r = h, h = r.parent) {
      r instanceof k
        && r.index < 0
        && ((i = h.enter(e, s, n)) === null || void 0 === i ? void 0 : i.from) != r.from
        && (t = h);
    }
  }
  for (;;) {
    const r = t.enter(e, s, n);
    if (!r) return t;
    t = r;
  }
}
class k {
      ...
      for (let { children: o, positions: a } = h._tree, u = e > 0 ? o.length : -1; t != u; t += e) {
        ...
        if (p(i, s, f, f + u.length)) {
          if (u instanceof c) {
            ...
            const r = u.findChild(0, u.buffer.length, e, s - f, i);
            if (r > -1) return new O(new b(h, u, t, f), null, r);
          } else if (n & l.IncludeAnonymous || !u.type.isAnonymous || P(u)) {
            let o;
            if (!(n & l.IgnoreMounts) && u.props && (o = u.prop(r.mounted)) && !o.overlay) return new k(o.tree, f, t, h);
            const a = new k(u, f, t, h);
  ...
  enter(t, e, s = 0) {
    ...
    if (!(s & l.IgnoreOverlays) && (i = this._tree.prop(r.mounted)) && i.overlay) {
      const s = t - this.from;
      for (const { from: t, to: r } of i.overlay) if ((e > 0 ? t <= s : t < s) && (e < 0 ? r >= s : r > s)) return new k(i.tree, i.overlay[0].from + this.from, -1, this);
    }
...
function x(t, e, s, r) {
  ...
  if (s != null) for (; !i.type.is(s);) if (!i.nextSibling()) return n;
  for (;;) {
...
class O {
  ...
  child(t, e, s) {
    ...
    const i = r.findChild(this.index + 4, r.buffer[this.index + 3], t, e - this.context.start, s);
  ...
  get nextSibling() {
    const { buffer: t } = this.context;
    const e = t.buffer[this.index + 3];
  ...
  get prevSibling() {
    const { buffer: t } = this.context;
    const e = this._parent ? this._parent.index + 4 : 0;
    return this.index == e
      ? this.externalSibling(-1)
  ...
  toTree() {
    const t = [];
    const e = [];
    const { buffer: s } = this.context;
    const r = this.index + 4;
    const i = s.buffer[this.index + 3];
    if (i > r) {
      const n = s.buffer[this.index + 1];
      const h = s.buffer[this.index + 2];
...
class y {
  ...
  yieldBuf(t, e) {
    this.index = t;
    const { start: s, buffer: r } = this.buffer;
    return (
  ...
  enterChild(t, e, s) {
    ...
    const i = r.findChild(this.index + 4, r.buffer[this.index + 3], t, e - this.buffer.start, s);
  ...
  parent() {
    ...
    const t = this.mode & l.IncludeAnonymous
      ? this.buffer.parent
  ...
  atLastNode(t) {
    ...
    if (r) {
      ...
      } else for (let t = 0; t < this.index; t++) if (r.buffer.buffer[t + 3] < this.index) return !1;
      ({ index: e, parent: s } = r);
    } else ({ index: e, _parent: s } = this._tree);
    for (; s; { index: e, _parent: s } = s) {
      if (e > -1) {
        for (let r = e + t, i = t < 0 ? -1 : s._tree.children.length; r != i; r += t) {
          const t = s._tree.children[r];
          if (this.mode & l.IncludeAnonymous || t instanceof c || !t.type.isAnonymous || P(t)) return !1;
        }
      }
    }
    return !0;
  ...
  matchContext(t) {
    ...
    for (let r = t.length - 1, i = this.stack.length - 1; r >= 0; i--) {
      ...
      const n = s[e.buffer[this.stack[i]]];
      if (!n.isAnonymous) {
...
function v(e) {
  ...
  const l = Array.isArray(i) ? new f(i, i.length) : i;
  const p = n.types;
  let d = 0;
  let g = 0;
  function k(t, e, s, r, i) {
    const {
      id: u, start: f, end: P, size: v,
    } = l;
    const C = g;
    for (; v < 0;) {
      if ((l.next(), v == -1)) {
      ...
      if (v == -3) return void (d = u);
      if (v == -4) return void (g = u);
    ...
    if (P - f <= h && (A = O(l.pos - e, i))) {
      const e = new Uint16Array(A.size - A.skip);
      const s = l.pos - A.size;
      let r = e.length;
  ...
  function b(t, e, s, i, n = 0, h) {
    if (d) {
      const t = [r.contextHash, d];
      h = h ? [t].concat(h) : [t];
    }
    if (n > 25) {
      const t = [r.lookAhead, n];
      h = h ? [t].concat(h) : [t];
    }
  ...
  function y(t, e, s) {
    ...
    } else h == -3 ? (d = r) : h == -4 && (g = r);
    return s;
  }
  const P = [];
  const v = [];
  for (; l.pos > 0;) k(e.start || 0, e.bufferStart || 0, P, v, -1);
  const C = (s = e.length) !== null && void 0 !== s ? s : P.length ? v[0] + P[0].length : 0;
...
class A {
  ...
  static addTree(t, e = [], s = !1) {
    const r = [new A(0, t.length, t, 0, !1, s)];
    for (const s of e) s.to > t.length && r.push(s);
    return r;
  }
  ...
  static applyChanges(t, e, s = 128) {
    ...
    const r = [];
    let i = 1;
    let n = t.length ? t[0] : null;
    for (let h = 0, o = 0, a = 0; ; h++) {
      const l = h < e.length ? e[h] : null;
      const u = l ? l.fromA : 1e9;
      if (u - o >= s) {
        for (; n && n.from < u;) {
          let e = n;
          if (o >= e.from || u <= e.to || a) {
            const t = Math.max(e.from, o) - a;
            const s = Math.min(e.to, u) - a;
...
class R {
  ...
  reduce(t) {
    const e = t >> 19;
    const s = 65535 & t;
    const { parser: r } = this.p;
    const i = r.dynamicPrecedence(s);
    if ((i && (this.score += i), e == 0)) {
      return (
    ...
    const n = this.stack.length - 3 * (e - 1) - (262144 & t ? 6 : 0);
    const h = this.stack[n - 2];
    const o = this.stack[n - 1];
    const a = this.bufferBase + this.buffer.length - o;
    if (s < r.minRepeatTerm || 131072 & t) {
      const t = r.stateFlag(this.state, 1) ? this.pos : this.reducePos;
      this.storeNode(s, h, t, a + 4, !0);
    }
    if (262144 & t) this.state = this.stack[n];
    else {
      const t = this.stack[n - 3];
  ...
  storeNode(t, e, s, r = 4, i = !1) {
    if (
      ...
      if (
        (r == 0 && t.parent && ((r = t.bufferBase - t.parent.bufferBase), (t = t.parent)),
        r > 0 && t.buffer[r - 4] == 0 && t.buffer[r - 1] > -1)
      ) {
        if (e == s) return;
  ...
  split() {
    ...
    const s = t.buffer.slice(e);
    const r = t.bufferBase + e;
  ...
  recoverByDelete(t, e) {
    const s = t <= this.p.parser.maxNode;
  ...
  canShift(t) {
    for (let e = new z(this); ;) {
      const s = this.p.parser.stateSlot(e.state, 4) || this.p.parser.hasAction(e.state, t);
      if ((65536 & s) == 0) return !0;
      if (s == 0) return !1;
      e.reduce(s);
    }
  }
  ...
  recoverByInsert(t) {
    ...
    if (e.length > 8 || this.stack.length >= 120) {
      const s = [];
      for (let r, i = 0; i < e.length; i += 2) (r = e[i + 1]) != this.state && this.p.parser.hasAction(r, t) && s.push(e[i], r);
  ...
  forceReduce() {
    const t = this.p.parser.stateSlot(this.state, 5);
    if ((65536 & t) == 0) return !1;
    const { parser: e } = this.p;
    if (!e.validAction(this.state, t)) {
      const s = t >> 19;
      const r = 65535 & t;
      const i = this.stack.length - 3 * s;
  ...
  updateContext(t) {
    if (t != this.curContext.context) {
      const e = new _(this.curContext.tracker, t);
...
class z {
  ...
  reduce(t) {
    ...
    s == 0
      ...
      (this.base += 3))
      : (this.base -= 3 * (s - 1));
    const r = this.start.p.parser.getGoto(this.stack[this.base - 3], e, !0);
    this.state = r;
  }
}
class Q {
...
class B {
  ...
  peek(t) {
    let e;
    let s;
    const r = this.chunkOff + t;
    if (r >= 0 && r < this.chunk.length) (e = this.pos + t), (s = this.chunk.charCodeAt(r));
    else {
      const r = this.resolveOffset(t, 1);
      if (r == null) return -1;
      if (((e = r), e >= this.chunk2Pos && e < this.chunk2Pos + this.chunk2.length)) s = this.chunk2.charCodeAt(e - this.chunk2Pos);
      else {
  ...
  acceptToken(t, e = 0) {
    const s = e ? this.resolveOffset(e, -1) : this.pos;
  ...
  getChunk() {
    if (this.pos >= this.chunk2Pos && this.pos < this.chunk2Pos + this.chunk2.length) {
      ...
      const t = this.input.chunk(this.pos);
      const e = this.pos + t.length;
  ...
  t: for (; (n & t[i]) != 0;) {
    ...
    for (let r = i + 3; r < s; r += 2) {
      if ((t[r + 1] & n) > 0) {
        ...
        if (
          o.allows(s)
          && (e.token.value == -1 || e.token.value == s || h.overrides(s, e.token.value))
        ) {
          e.acceptToken(s);
          break;
        }
...
const G = typeof process !== 'undefined' && /\bparse\b/.test(process.env.LOG);
let F = null;
let U; let
  Z;
function j(t, e, s) {
  const r = t.cursor(l.IncludeAnonymous);
  for (r.moveTo(e); ;) {
...
class q {
  ...
  nextFragment() {
    const t = (this.fragment = this.i == this.fragments.length ? null : this.fragments[this.i++]);
    if (t) {
      for (
  ...
  nodeAt(t) {
    ...
    for (;;) {
      const e = this.trees.length - 1;
      if (e < 0) return this.nextFragment(), null;
      const s = this.trees[e];
      ...
      const h = this.start[e] + s.positions[i];
...
class W {
  ...
  getActions(t) {
    ...
    let s = null;
    const { parser: r } = t.p;
    const { tokenizers: i } = r;
    const n = r.stateSlot(t.state, 3);
    const h = t.curContext ? t.curContext.hash : 0;
    let o = 0;
    for (let r = 0; r < i.length; r++) {
      if (((1 << r) & n) == 0) continue;
      const a = i[r];
      const l = this.tokens[r];
      if (
        (!s || a.fallback)
    ...
    if ((e.token(this.stream.reset(s.pos, t), s), t.value > -1)) {
      ...
      for (let r = 0; r < e.specialized.length; r++) {
        if (e.specialized[r] == t.value) {
          const i = e.specializers[r](this.stream.read(t.start, t.end), s);
          if (i >= 0 && s.p.parser.dialect.allows(i >> 1)) {
            (1 & i) == 0 ? (t.value = i >> 1) : (t.extended = i >> 1);
            break;
          }
        }
      }
  ...
  addActions(t, e, s, r) {
    ...
    for (let t = 0; t < 2; t++) {
      for (let o = n.stateSlot(i, t ? 2 : 1); ; o += 3) {
        if (h[o] == 65535) {
          if (h[o + 1] != 1) {
            r == 0 && h[o + 1] == 2 && (r = this.putAction(et(h, o + 2), e, s, r));
            break;
          }
          o = et(h, o + 2);
        }
...
class X {
  constructor(t, e, s, r) {
    ...
    (this.fragments = s.length && this.stream.end - i > 4 * t.bufferLength ? new q(s, t.nodeSet) : null);
  }
  ...
  advance() {
    ...
    for (let n = 0; n < s.length; n++) {
      ...
      for (;;) {
        if (((this.tokens.mainToken = null), h.pos > r)) i.push(h);
          ...
          {
            t || ((t = []), (e = [])), t.push(h);
            const s = this.tokens.getMainToken(h);
    ...
    if (this.recovering && t) {
      const s = this.stoppedAt != null && t[0].pos > this.stoppedAt ? t[0] : this.runRecovery(t, e, i);
      if (s) return this.stackToTree(s.forceAll());
    }
    if (this.recovering) {
      const t = this.recovering == 1 ? 1 : 3 * this.recovering;
  ...
  advanceStack(t, e, s) {
    const i = t.pos;
    const { parser: n } = this;
    const h = G ? `${this.stackID(t)} -> ` : '';
    if (this.stoppedAt != null && i > this.stoppedAt) return t.forceReduce() ? t : null;
    if (this.fragments) {
      const e = t.curContext && t.curContext.tracker.strict;
      const s = e ? t.curContext.hash : 0;
      for (let o = this.fragments.nodeAt(i); o;) {
        const i = this.parser.nodeSet.types[o.type.id] == o.type ? n.getGoto(t.state, o.type.id) : -1;
        ...
        if (!(o instanceof u) || o.children.length == 0 || o.positions[0] > 0) break;
        const a = o.children[0];
        if (!(a instanceof u && o.positions[0] == 0)) break;
        o = a;
      }
    }
    const o = n.stateSlot(t.state, 4);
    if (o > 0) {
      return (
        t.reduce(o),
    ...
    const a = this.tokens.getActions(t);
    for (let r = 0; r < a.length;) {
      const o = a[r++];
      const l = a[r++];
      const u = a[r++];
      const f = r == a.length || !s;
      const c = f ? t : t.split();
      if (
        (c.apply(o, l, u),
        G
          && console.log(
            `${h
              ...
              (65536 & o) == 0 ? 'shift' : `reduce of ${n.getName(65535 & o)}`
  ...
  runRecovery(t, e, s) {
    ...
    for (let n = 0; n < t.length; n++) {
      ...
      for (const t of h.recoverByInsert(o)) G && console.log(`${l + this.stackID(t)} (via recover-insert)`), this.advanceFully(t, s);
...
class tt extends T {
  constructor(e) {
    ...
    const s = e.nodeNames.split(' ');
    this.minRepeatTerm = s.length;
    for (let t = 0; t < e.repeatNodeCount; t++) s.push('');
    const i = Object.keys(e.topRules).map(t => e.topRules[t][1]);
    const o = [];
    ...
    (this.tokenizers = e.tokenizers.map(t => (typeof t === 'number' ? new V(l, t) : t))),
  ...
  createParse(t, e, s) {
    ...
    for (const i of this.wrappers) r = i(r, t, e, s);
    return r;
  }
  ...
  hasAction(t, e) {
    ...
    for (let r = 0; r < 2; r++) {
      for (let i, n = this.stateSlot(t, r ? 2 : 1); ; n += 3) {
        if ((i = s[n]) == 65535) {
          if (s[n + 1] != 1) {
            if (s[n + 1] == 2) return et(s, n + 2);
            break;
          }
          i = s[(n = et(s, n + 2))];
        }
        if (i == e || i == 0) return et(s, n + 1);
      }
    }
    return 0;
  }
  ...
  nextStates(t) {
    ...
    for (let s = this.stateSlot(t, 1); ; s += 3) {
      if (this.data[s] == 65535) {
        if (this.data[s + 1] != 1) break;
        s = et(this.data, s + 2);
      }
      if ((1 & this.data[s + 2]) == 0) {
        const t = this.data[s + 1];
  ...
  overrides(t, e) {
    const s = st(this.data, this.tokenPrecTable, e);
    return s < 0 || st(this.data, this.tokenPrecTable, t) < s;
  }

  configure(t) {
    const e = Object.assign(Object.create(tt.prototype), this);
    if ((t.props && (e.nodeSet = this.nodeSet.extend(...t.props)), t.top)) {
      const s = this.topRules[t.top];
    ...
    return (
      t.tokenizers
        && (e.tokenizers = this.tokenizers.map((e) => {
          const s = t.tokenizers.find(t => t.from == e);
          return s ? s.to : e;
        })),
  ...
  dynamicPrecedence(t) {
    const e = this.dynamicPrecedences;
    return e == null ? 0 : e[t] || 0;
  }

  parseDialect(t) {
    const e = Object.keys(this.dialects);
    const s = e.map(() => !1);
    if (t) {
    ...
    let r = null;
    for (let t = 0; t < e.length; t++) if (!s[t]) for (let s, i = this.dialects[e[t]]; (s = this.data[i++]) != 65535;) (r || (r = new Uint8Array(this.maxTerm + 1)))[s] = 1;
    return new H(t, s, r);
  }
...
function st(t, e, s) {
  for (let r, i = e; (r = t[i]) != 65535; i++) if (r == s) return i - e;
  return -1;
}
function rt(t) {
  let e = null;
  for (const s of t) {
    const t = s.p.stoppedAt;
    (s.pos == s.p.stream.end || (t != null && s.pos > t))
...
const ft = new E((t) => {
  let e = '';
  for (; !(t.next < 0);) {
    if (t.next === 46 && e === 'lost') return t.advance(), void t.acceptToken(nt);
    const s = String.fromCharCode(t.next);
    if (ut.indexOf(s) > -1) break;
    if (t.peek(1) === 803) break;
    (e += s), t.advance();
  }
...
const dt = new E((t) => {
  if (t.next === 40) {
    let e;
    for (; (e = t.advance()) > -1;) if (e === 41) return void t.acceptToken(lt);
  }
});
const gt = tt.deserialize({
  version: 14,
  states:
...
const kt = ['Recto', 'Verso', 'Fragment', 'Part', 'Div'];
const xt = 'xmlns="http://www.tei-c.org/ns/1.0"';
      ...
      enter: (t) => {
        ...
        switch (e) {
          case 'Document':
            ...
            if (t.firstChild()) {
              do {
                l++, kt.includes(t.type.name) && (a = 'div'), (h = h || t.type.name === 'Inline');
              } while (t.nextSibling());
            }
          ...
          case 'Unclear':
            ...
            for (let t = 0; t < d.length; t++) {
              ...
              e && e !== 803 && (g += String.fromCodePoint(e));
            }
