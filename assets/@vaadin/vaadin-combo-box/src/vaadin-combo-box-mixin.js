/// BareSpecifier=@vaadin/vaadin-combo-box/src/vaadin-combo-box-mixin
/**
@license
...
export const ComboBoxMixin = subclass => class VaadinComboBoxMixinElement extends subclass {
  ...
  _repositionOverlay() {
    ...
    this.__repositionOverlayDebouncer = Debouncer.debounce(this.__repositionOverlayDebouncer,
