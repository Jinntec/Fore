/// BareSpecifier=web-animations-js/src/web-animations-next-animation
  ...
  scope.Animation.prototype = {
    ...
    _updateChildren: function () {
      ...
      this._childAnimations.forEach(function (childAnimation) {
        ...
        if (this.effect instanceof window.SequenceEffect) offset += scope.groupChildDuration(childAnimation.effect);
      }.bind(this));
    },
    ...
    _constructChildAnimations: function () {
      ...
      this.effect.children.forEach(function (child) {
        ...
        if (this.effect instanceof window.SequenceEffect) offset += scope.groupChildDuration(child);
      }.bind(this));
    },
    ...
    _forEachChild: function (f) {
      ...
      this._childAnimations.forEach(function (child) {
        ...
        if (this.effect instanceof window.SequenceEffect) offset += child.effect.activeDuration;
      }.bind(this));

      if (this.playState == 'pending') return;
      var timing = this.effect._timing;
      var t = this.currentTime;
      if (t !== null) t = shared.calculateIterationProgress(shared.calculateActiveDuration(timing), t, timing);
