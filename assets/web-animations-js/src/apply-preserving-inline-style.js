/// BareSpecifier=web-animations-js/src/apply-preserving-inline-style
...
(function (scope, testing) {
  ...
  for (var method in styleMethods) {
    AnimatedCSSStyleDeclaration.prototype[method] = function (method, modifiesStyle) {
      return function () {
        ...
        if (modifiesStyle) {
          if (!this._isAnimatedProperty[arguments[0]]) this._style[method].apply(this._style, arguments);
          this._updateIndices();
        }
        return result;
      };
  ...
  function ensureStyleIsPatched(element) {
    ...
    try {
      configureProperty(element, 'style', { get: function () {
