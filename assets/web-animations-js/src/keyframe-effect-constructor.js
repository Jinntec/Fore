/// BareSpecifier=web-animations-js/src/keyframe-effect-constructor
...
(function (shared, scope, testing) {
  ...
  scope.KeyframeEffect.prototype = {
    getFrames: function () {
      if (typeof this._normalizedKeyframes == 'function') return this._normalizedKeyframes;
  ...
  Object.defineProperty(window, 'getComputedStyle', {
    ...
    value: function () {
      ...
      if (updatePendingGroups()) result = originalGetComputedStyle.apply(this, arguments);
      scope.timeline._updateAnimationsPromises();
      return result;
    }
  });
