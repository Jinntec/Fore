 ...
 * respectively.
 */
interface PaperDropdownMenuElement extends IronButtonState, IronControlState, IronFormElementBehavior, IronValidatableBehavior, LegacyElementMixin, HTMLElement {
  keyBindings: object;
...
export {PaperDropdownMenuElement};
