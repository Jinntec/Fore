/// BareSpecifier=@polymer/neon-animation/demo/list/full-view
/**
@license
...
Polymer({
  ...
  attached: function () {
    ...
    this.animationConfig = {
      'entry': [{ name: 'fade-in-animation', node: this.$.button }, { name: 'hero-animation', id: 'hero', toPage: this }],

      'exit': [{ name: 'fade-out-animation', node: this.$.button }, {
