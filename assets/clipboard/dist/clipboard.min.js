...
!function (t, e) {
  ...
  return function (n) {
    ...
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
      ...
      }(o, c.default), i(o, [{ key: "resolveOptions", value: function () {
    ...
    var d = n(5),
      ...
      if (!t && !e && !n) throw new Error("Missing required arguments");if (!d.string(e)) throw new TypeError("Second argument must be a String");if (!d.fn(n)) throw new TypeError("Third argument must be a Function");if (d.node(t)) return s = e, f = n, (l = t).addEventListener(s, f), { destroy: function () {
