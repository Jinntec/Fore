/// BareSpecifier=prismjs/components/prism-regex.min
!function (n) {
  var e = { pattern: /\\[\\(){}[\]^$+*?|.]/, alias: "escape" },
    ...
    var a = n.languages[e];a && (a.regex.inside = { "regex-flags": /[a-z]+$/, "regex-delimiter": /^\/|\/$/, "language-regex": { pattern: /[\s\S]+/, inside: n.languages.regex } });
  });
}(Prism);