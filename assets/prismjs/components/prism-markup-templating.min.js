/// BareSpecifier=prismjs/components/prism-markup-templating.min
!function (h) {
  function v(e, n) {
    return "___" + e.toUpperCase() + n + "___";
        ...
        if (a.language === r) {
          var c = a.tokenStack = [];a.code = a.code.replace(e, function (e) {
            if ("function" == typeof o && !o(e)) return e;for (var n, t = c.length; -1 !== a.code.indexOf(n = v(r, t));) ++t;return c[t] = e, n;
