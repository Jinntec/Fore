...
!function () {
  if ("undefined" != typeof self && self.Prism && self.document) {
    var u = /(?:^|\s)command-line(?:\s|$)/;Prism.hooks.add("before-highlight", function (e) {
            ...
            var r = e.code.split("\n");a.numberOfLines = r.length;var s = a.outputLines = [],
              ...
              o = o.split(",");for (var l = 0; l < o.length; l++) {
                var m = o[l].split("-"),
                  ...
                  p < 1 && (p = 1), d > r.length && (d = r.length), d--;for (var c = --p; c <= d; c++) s[c] = r[c], r[c] = "";
                }
              }
            } else if (i) for (l = 0; l < r.length; l++) 0 === r[l].indexOf(i) && (s[l] = r[l].slice(i.length), r[l] = "");e.code = r.join("\n");
          }
        } else a.complete = !0;
      } else a.complete = !0;
      ...
      var t = e.vars = e.vars || {},
          a = t["command-line"] = t["command-line"] || {};if (!a.complete) {
        var n = e.element.parentNode;u.test(e.element.className) && (e.element.className = e.element.className.replace(u, " ")), u.test(n.className) || (n.className += " command-line");var r = function (e, t) {
        ...
        }var m = document.createElement("span");m.className = "command-line-prompt", m.innerHTML = s;for (var p = 0; p < a.outputLines.length; p++) if (a.outputLines.hasOwnProperty(p)) {
          var d = m.children[p];d.removeAttribute("data-user"), d.removeAttribute("data-host"), d.removeAttribute("data-prompt");
