/// BareSpecifier=prismjs/plugins/line-highlight/prism-line-highlight.min
!function () {
  if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
    var t,
      ...
      var t = e.element.parentElement,
        ...
        var i = 0;v(".line-highlight", t).forEach(function (e) {
      ...
      var n = t.element.parentElement,
        ...
        clearTimeout(a);var r = Prism.plugins.lineNumbers,
            o = t.plugins && t.plugins.lineNumbers;if (y(n, "line-numbers") && r && !o) Prism.hooks.add("line-numbers", e);else l(n, i)(), a = setTimeout(u, 1);
      }
    }), window.addEventListener("hashchange", u), window.addEventListener("resize", function () {
      v("pre[data-line]").map(function (e) {
        return l(e);
      }).forEach(E);
    });
  }function v(e, t) {
    ...
    var t = (e = "string" == typeof e ? e : u.getAttribute("data-line")).replace(/\s+/g, "").split(",").filter(Boolean),
        ...
        m = p ? u : n || u,
        h = [],
        g = n && m != n ? function (e, t) {
      var n = getComputedStyle(e),
          i = getComputedStyle(t);function r(e) {
        return +e.substr(0, e.length - 2);
      }return t.offsetTop + r(i.borderTopWidth) + r(i.paddingTop) - r(n.paddingTop);
    }(u, n) : 0;t.forEach(function (e) {
      var t = e.split("-"),
          n = +t[0],
          i = +t[1] || n,
          r = u.querySelector('.line-highlight[data-range="' + e + '"]') || document.createElement("div");if (h.push(function () {
        ...
        var o = Prism.plugins.lineNumbers.getLine(u, n),
          ...
          var l = o.offsetTop + g + "px";h.push(function () {
            r.style.top = l;
          });
        }if (a) {
          var s = a.offsetTop - o.offsetTop + a.offsetHeight + "px";h.push(function () {
            r.style.height = s;
          });
        }
      } else h.push(function () {
        r.setAttribute("data-start", String(n)), n < i && r.setAttribute("data-end", String(i)), r.style.top = (n - c - 1) * f + g + "px", r.textContent = new Array(i - n + 2).join(" \n");
      });h.push(function () {
        m.appendChild(r);
      });
    });var i = u.id;if (p && i) {
      for (var r = "linkable-line-numbers", o = !1, a = u; a;) {
        ...
        y(u, r) || h.push(function () {
          u.className = (u.className + " " + r).trim();
        });var l = parseInt(u.getAttribute("data-start") || "1");v(".line-numbers-rows > span", u).forEach(function (e, t) {
          var n = t + l;e.onclick = function () {
            var e = i + "." + n;b = !1, location.hash = e, setTimeout(function () {
              b = !0;
            }, 1);
          };
        });
    ...
    var e = location.hash.slice(1);v(".temporary.line-highlight").forEach(function (e) {
      e.parentNode.removeChild(e);
    });var t = (e.match(/\.([\d,-]+)$/) || [, ""])[1];if (t && !document.getElementById(e)) {
      var n = e.slice(0, e.lastIndexOf(".")),
          i = document.getElementById(n);if (i) i.hasAttribute("data-line") || i.setAttribute("data-line", ""), l(i, t, "temporary ")(), b && document.querySelector(".temporary.line-highlight").scrollIntoView();
    }
  }
}();