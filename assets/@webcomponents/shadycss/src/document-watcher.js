/// BareSpecifier=@webcomponents/shadycss/src/document-watcher
/**
@license
...
export function ensureCorrectSubtreeScoping(element) {
  ...
  const unscopedNodes = window['ShadyDOM']['nativeMethods']['querySelectorAll'].call(element, `:not(.${StyleTransformer.SCOPE_NAME})`);
