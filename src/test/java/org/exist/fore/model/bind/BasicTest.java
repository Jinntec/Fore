...
public class BasicTest extends TestCase {
    ...
    public void setUp() throws Exception {
        String path = getClass().getResource("basic.html").getPath();
        String fileURI = "file://" + path.substring(0, path.lastIndexOf("basic.html"));
...
//        DOMUtil.prettyPrintDOM(doc);
    ...
    public void testInit() {
        ...
        assertEquals(1,this.model.getModelBindings().size());
