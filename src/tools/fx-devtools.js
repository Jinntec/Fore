...
export class FxDevtools extends HTMLElement {
    static get properties() {
        return {
            ...
            selector: {
                type: String,
                description:
                    'optional selector to attach to a certain fx-fore element with given id',
            },
        };
    }
    ...
    constructor() {
        ...
        if (fore) {
            ...
            if (fore.inited) {
                ...
                fore.addEventListener('model-construct-done', () =>
                    attachToFore(fore),
                );
            }
        }
    ...
    _getInstanceForTarget(node) {
        this.instances.forEach((instance) => {
            if (
                instance.type === 'xml' &&
                instance.instanceData.contains(node)
            ) {
                return instance;
            }
      ...
      `;
        ...
        caption.addEventListener('click', (ev) => {
            if (
                ...
                ev.target.classList.contains('resizer')
            ) {
                return;
            }
