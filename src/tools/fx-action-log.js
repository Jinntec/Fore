...
export class FxActionLog extends HTMLElement {
    ...
    `;
        ...
        if (localStorage.getItem('fx-action-log-filters')) {
            this.listenTo = JSON.parse(
                localStorage.getItem('fx-action-log-filters'),
            );
        } else {
    ...
    _defaultSettings() {
        this.listenTo = [
            ...
            },
            {
                ...
                show: false,
                description:
                    'fires after a fx-fore page has been completely initialized',
            },
            {
                name: 'rebuild-done',
                show: false,
            ...
            },
            {
                ...
                show: false,
                description:
                    'fired by embedded Fore controls to return their bound value',
            },
            {
                name: 'select',
                show: false,
            ...
            },
            {
                ...
                show: false,
                description:
                    'fires after a submission has successfully been executed',
            },
            {
                name: 'submit-error',
                show: false,
    ...
    _log(e, log) {
        ...
        logRowTarget.addEventListener('click', (e) => {
            const alreadyLogged = document.querySelectorAll(
                '.fx-action-log-debug',
            );
        ...
        switch (actionElement.nodeName) {
            ...
            case 'FX-SEND':
                const submission = document.querySelector(
                    `#${e.detail.action.getAttribute('submission')}`,
                );
