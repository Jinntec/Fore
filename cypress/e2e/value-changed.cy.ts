describe('value-changed event firing', () => {
    ...
    it.skip('triggers the correct events with the correct data for the default instance', () => {
    ...
    it.skip('triggers the correct events with the correct data for the second instance', () => {
    ...
    it.skip('also allows aliased variables', () => {
